...
**Back up the entire data root before upgrading** (back up an external database separately). Older versions treat `projects/` as a project and do not recognize the new database file name; downgrading requires restoring that backup.
