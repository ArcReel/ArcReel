...
参考生视频不等于不需要资产图。旁白/解说和剧情演绎项目引用的资产缺少设计图时，相关视频会失败；广告/短片缺少商品参考图时，即使任务能够继续，商品还原度也无法保证。
...
3. 分镜路线检查目标镜头是否已有分镜图。
4. 参考生视频路线中，旁白/解说和剧情演绎项目检查被引用资产的设计图是否齐全；广告/短片项目至少确认商品原图已上传，缺少参考图虽可能不阻塞任务，但会降低商品保真度。
...
### 为什么场景设计图里出现了人物？ {#people-in-scene-images}
