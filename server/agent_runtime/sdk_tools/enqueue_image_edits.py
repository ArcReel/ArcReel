...
def edit_images_tool(ctx: ToolContext):
    @tool(
        ...
        "resource_type 支持 character/scene/prop/product/storyboard/reference_keyframe/"
        "reference_storyboard_sheet 七类，后面三类必须带 script_file。"
    ...
    async def _handler(args: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            is_script_owned = is_storyboard or resource_type in {
                "reference_keyframe",
                        ...
                        "content": [
                            {
                                "type": "text",
                                "text": (
                                    "storyboard/reference_keyframe/reference_storyboard_sheet 编辑时 script_file 必填"
                                ),
                            }
                        ],
                        "is_error": True,
