MESSAGES = {
    ...
    "video_reference_audio_duration_exceeded": "Model {model} supports at most {limit} seconds of combined reference audio but received {total:.1f} seconds; use fewer reference audio clips or shorter clips",
