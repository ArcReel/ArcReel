MESSAGES = {
    ...
    "voice_sample_video_audio_unavailable": "The current video model cannot produce extractable speech. Use TTS or upload reference audio instead",
    "voice_sample_video_duration_unavailable": "The current video model has no supported duration from 2 to 10 seconds. Use TTS or upload reference audio instead",
    "voice_sample_strategy_invalid": "Unsupported reference-audio generation strategy",
    ...
    "reference_keyframe_not_found": "Keyframe '{id}' not found",
    "reference_keyframe_limit": "Each video unit can contain at most {max_count} keyframes; split it into more video units",
    "reference_keyframe_task_submitted": "First-frame generation for keyframe '{id}' submitted",
    "reference_keyframes_task_submitted": "Submitted {count} keyframe first-frame generation tasks",
    "reference_storyboard_sheet_task_submitted": "Video Unit Storyboard Sheet generation submitted for video unit '{unit_id}'",
    "reference_storyboard_sheet_confirmed": "Confirmed the Video Unit Storyboard Sheet for video unit '{unit_id}' and submitted {count} keyframe tasks",
    "reference_storyboard_sheet_required": "Video unit '{unit_id}' must have a Video Unit Storyboard Sheet before continuing",
    "reference_keyframe_plan_required": "Video unit '{unit_id}' must define at least one keyframe before its Video Unit Storyboard Sheet can be confirmed",
    "reference_keyframe_images_required": "Video unit '{unit_id}' is still missing generated images for keyframes: {keyframe_ids}",
    "reference_storyboard_sheet_confirmation_required": "The Video Unit Storyboard Sheet for video unit '{unit_id}' has not been confirmed",
    "reference_storyboard_sheet_input_changed": "Video unit '{unit_id}' changed while its Video Unit Storyboard Sheet was being generated; regenerate it",
    "reference_storyboard_sheet_changed": "The Video Unit Storyboard Sheet for video unit '{unit_id}' changed; refresh and confirm again",
    "reference_storyboard_sheet_reference_limit": "Confirming the Video Unit Storyboard Sheet for video unit '{unit_id}' would use {count} reference images, above the model limit of {max_count}; split the unit or reduce references",
    "reference_storyboard_sheet_keyframes_enqueue_failed": "The Video Unit Storyboard Sheet was confirmed, but {failed_count} keyframe tasks for video unit '{unit_id}' could not be submitted",
    ...
    "image_edit_script_file_required": "script_file is required when editing a storyboard or reference keyframe image",
