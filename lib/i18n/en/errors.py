MESSAGES = {
    ...
    "video_capability_missing_i2v": "{provider}/{model} does not support generating video from a storyboard first frame; assign a model that supports it for image-to-video in Settings, or change the default video model",
    "video_capability_missing_r2v": "{provider}/{model} does not support reference image input; assign a reference-capable model for reference-to-video in Settings, or change the default video model",
