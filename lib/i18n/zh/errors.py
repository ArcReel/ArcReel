MESSAGES = {
    ...
    "narration_mode_required": "该脚本不是旁白/解说模式，请使用场景更新接口",
    "ad_mode_required": "该脚本不是广告/短片模式，请使用对应模式的更新接口",
    ...
    "tts_stale": "旁白音频比当前内容旧；使用 TTS 交付前请重新生成",
    ...
    "voice_sample_video_audio_unavailable": "当前视频模型不能生成可提取的人声，请改用 TTS 或上传参考音频",
    "voice_sample_video_duration_unavailable": "当前视频模型没有 2 到 10 秒的可用时长档位，请改用 TTS 或上传参考音频",
    "voice_sample_strategy_invalid": "不支持的参考音频生成方式",
    ...
    "style_description_requires_custom_mode": "预设风格不能同时保存自定义风格描述，请先切换到自定义风格",
    ...
    "reference_keyframe_not_found": "关键分镜「{id}」不存在",
    "reference_keyframe_limit": "每个视频单元最多包含 {max_count} 个关键分镜；请拆分为更多视频单元",
    "reference_keyframe_task_submitted": "关键分镜「{id}」首帧生成任务已提交",
    "reference_keyframes_task_submitted": "已提交 {count} 个关键分镜首帧生成任务",
    "reference_storyboard_sheet_task_submitted": "视频单元「{unit_id}」的 Video Unit Storyboard Sheet 生成任务已提交",
    "reference_storyboard_sheet_confirmed": "已确认视频单元「{unit_id}」的 Video Unit Storyboard Sheet，并提交 {count} 个关键分镜任务",
    "reference_storyboard_sheet_required": "视频单元「{unit_id}」必须先生成 Video Unit Storyboard Sheet",
    "reference_keyframe_plan_required": "视频单元「{unit_id}」必须至少定义一个关键分镜，才能确认 Video Unit Storyboard Sheet",
    "reference_keyframe_images_required": "视频单元「{unit_id}」仍缺少以下关键分镜首帧：{keyframe_ids}",
    "reference_storyboard_sheet_confirmation_required": "视频单元「{unit_id}」的 Video Unit Storyboard Sheet 尚未确认",
    "reference_storyboard_sheet_input_changed": "视频单元「{unit_id}」在 Video Unit Storyboard Sheet 生成期间发生变化，请重新生成",
    "reference_storyboard_sheet_changed": "视频单元「{unit_id}」的 Video Unit Storyboard Sheet 已变化，请刷新后重新确认",
    "reference_storyboard_sheet_reference_limit": "视频单元「{unit_id}」确认 Video Unit Storyboard Sheet 后共有 {count} 张参考图，超过模型上限 {max_count}；请拆分单元或减少引用",
    "reference_storyboard_sheet_keyframes_enqueue_failed": "Video Unit Storyboard Sheet 已确认，但视频单元「{unit_id}」有 {failed_count} 个关键分镜任务未能提交",
    ...
    "image_edit_script_file_required": "编辑分镜图或关键分镜需要提供 script_file",
