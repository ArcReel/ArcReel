MESSAGES = {
    ...
    "grid_task_submitted_with_unsplit": "Đã gửi {count} tác vụ tạo phân cảnh đa lưới; còn {unsplit} ảnh ghép chưa tách, hãy xem lại rồi tách vào khung hình",
    "grid_unsplit_awaiting_split": "{unsplit} ảnh ghép đã sẵn sàng nhưng chưa tách; hãy xem lại rồi tách vào khung hình. Không có phân cảnh đa lưới nào cần tạo mới",
    "grid_nothing_to_generate": "Mọi nhóm đều đã có ảnh phân cảnh; không có phân cảnh đa lưới nào cần tạo",
    "grid_script_route_mismatch": "Cấu trúc kịch bản không khớp với chế độ tạo của dự án nên không thể tạo phân cảnh đa lưới",
