MESSAGES = {
    ...
    "video_duration_unavailable": "Không thể đo video đã tạo so với phần thuyết minh {tts_duration}s; hãy tạo lại video",
    "video_shorter_than_tts": "Video đã tạo dài {video_duration}s, ngắn hơn phần thuyết minh {tts_duration}s; hãy tạo lại mà không cắt hoặc tăng tốc lời nói",
