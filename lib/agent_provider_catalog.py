...
PRESET_PROVIDERS: dict[str, PresetProvider] = {
    ...
    "orcarouter": PresetProvider(
        id="orcarouter",
        display_name="OrcaRouter",
        icon_key="OrcaRouter",
        messages_url="https://api.orcarouter.ai",
        discovery_url="https://api.orcarouter.ai",
        default_model="orcarouter/auto",
        suggested_models=(),
        docs_url="https://docs.orcarouter.ai",
        api_key_url="https://www.orcarouter.ai",
        notes_i18n_key="preset_notes_orcarouter",
        api_key_pattern=r"^sk-orca-[A-Za-z0-9]+$",
        is_recommended=False,
    ),
