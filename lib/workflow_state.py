...
class WorkflowActionType(StrEnum):
    ...
    GENERATE_REFERENCE_STORYBOARD_SHEETS = "generate_reference_storyboard_sheets"
    CONFIRM_REFERENCE_STORYBOARD_SHEET = "confirm_reference_storyboard_sheet"
    GENERATE_REFERENCE_KEYFRAMES = "generate_reference_keyframes"
