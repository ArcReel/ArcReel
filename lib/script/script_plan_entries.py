...
from lib.script.script_models import NarrationScriptPlanDraft, ReferenceScriptPlanDraft
...
#: ``lib.script.script_review`` 从本模块再导出，不另立一份。
...
class ScriptPlanVariant:
    ...
    #: 剧本骨架种类（``lib.script.script_skeleton.SKELETONS`` 的键）。
    skeleton_kind: str
