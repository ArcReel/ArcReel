...
job (:mod:`server.services.admission.video_batch_admission`); nothing here reads the
...
is reported through :class:`lib.generation.generation_result.GenerationBatchResult` as
usual.
"""
