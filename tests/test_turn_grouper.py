...
class TestTurnGrouper:
    ...
    def test_untyped_live_blocks_are_normalized_and_attached(self):
        raw_messages = [
            {"type": "user", "content": "start project using manga-workflow"},
            {
                "type": "assistant",
                "content": [
                    {
                        "text": "I will launch the workflow",
                    }
                ],
            },
            {
    ...
    def test_subagent_parent_user_text_is_filtered_from_assistant_turn(self):
        raw_messages = [
            {"type": "user", "content": "continue production"},
            {
                "type": "assistant",
                "content": [
                    {
                        ...
                        "id": "task-1",
                        "name": "Task",
                        "input": {"subagent_type": "Explore", "description": "check project status"},
                    }
                ],
            },
            {
                "type": "user",
                "content": [{"type": "text", "text": "Analysing project structure..."}],
        ...
        raw_messages = [
            ...
            },
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "Use Glob to find all skill files under .claude/skills/**/SKILL.md",
                    }
                ],
                "parent_tool_use_id": "agent-1",
            },
