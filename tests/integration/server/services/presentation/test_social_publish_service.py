...
from lib.speech.speech_presentation import RawPresentationMedia, materialize_raw_video_presentation
from server.services.presentation.presentation_read_model import MaterializedPresentation, PresentationUnavailableError
from server.services.presentation.social_publish import SocialPublishService, UploadPostCredentials
