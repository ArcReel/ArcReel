...
from lib.artifacts.artifact_manifest import ArtifactBasis, ArtifactKey, ArtifactManifest, ProjectArtifactManifestAdapter
...
def test_project_adapter_creates_lock_file_exclusively(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", record_lock_open)
...
def test_project_adapter_replace_failure_preserves_manifest_and_cleans_temp_file(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.replace", fail_replace)
...
def test_project_adapter_blocks_parent_replaced_by_symlink_during_open(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", swap_parent_then_open)
...
def test_project_adapter_blocks_file_symlink_swap_without_no_follow(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", swap_file_then_open)
...
def test_project_adapter_blocks_parent_vanishing_during_fallback_revalidation(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", move_parent_after_open)
...
def test_project_adapter_rejects_in_place_write_during_content_snapshot(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.read", mutate_after_first_read)
...
def test_project_adapter_reports_posix_artifact_read_failure(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.read", fail_read)
...
def test_project_adapter_rejects_project_root_symlink_swap_during_initialization(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.Path.resolve", swap_then_resolve)
...
def test_project_adapter_keeps_manifest_write_on_opened_root_during_swap(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", swap_root_then_open_lock)
...
def test_project_adapter_rejects_portable_manifest_symlink_swap(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", swap_manifest_then_open)
...
def test_project_adapter_rejects_lock_symlink_swap_without_no_follow(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", swap_lock_then_open)
...
def test_project_adapter_hashes_content_through_a_binary_descriptor(
    ...
    monkeypatch.setattr("lib.artifacts.artifact_manifest.os.open", record_open)
    adapter = ProjectArtifactManifestAdapter(project, nofollow_supported=False)
