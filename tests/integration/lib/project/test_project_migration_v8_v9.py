...
from lib.project.project_migrations.runner import MIGRATORS, migrate_project_dir, migrate_project_with_verdict
...
def test_startup_scan_and_archive_import_share_one_migration_entry() -> None:
    from server.services.project import project_archive
