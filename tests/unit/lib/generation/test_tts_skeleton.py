...
from lib.backends.audio_backends.base import AudioCapability, AudioSynthesisResult
from lib.db.base import Base
from lib.db.models.api_call import ApiCall
from lib.db.repositories.usage_repo import SettlementInput, UsageRepository
from lib.generation.generation_worker import CapacityTable, GenerationWorker, SlotTable
...
class TestExtractProviderAudio:
    async def test_audio_payload_provider_routes_to_audio_resolver(self):
        from lib.generation.generation_worker import _extract_provider
...
class TestDeriveExecutionModelForEnqueueAudio:
    async def test_tts_routes_to_audio_resolver(self, monkeypatch):
        ...
        from lib.generation import generation_queue as gq
