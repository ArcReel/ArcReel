...
def test_unsupported_output_profile_tells_the_caller_to_fix_the_request() -> None:
    ...
    assert problem.code == "video_output_profile_unsupported"
    assert problem.action is GenerationAction.FIX_INPUT
