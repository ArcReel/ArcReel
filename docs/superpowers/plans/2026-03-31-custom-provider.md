...
**Goal:** Allow users to integrate any OpenAI/Google compatible service via base_url + api_key, while also fixing 3 OpenAI preset provider improvements from #189.
...
Note: 此任务及后续前端任务执行前须先调用 `/frontend-design` skill。
