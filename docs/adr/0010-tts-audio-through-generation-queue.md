...
> `docs/adr/0058` 已把 TTS 产物范围与生成基数从“仅说书分镜路线、每 NarrationSegment 一段”扩展为“所有叙述旁白视频生成单元逐条生成”；本 ADR 关于 GenerationQueue/Worker 调度、同步 backend、任务面板与无 provider submit-poll-resume 的决定继续有效。
