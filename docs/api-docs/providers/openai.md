...
- 代码：`lib/config/registry.py::PROVIDER_REGISTRY["openai"]`、`lib/backends/text_backends/openai.py::OpenAITextBackend`、`lib/backends/image_backends/openai.py::OpenAIImageBackend`、`lib/backends/video_backends/openai.py::OpenAIVideoBackend`；TTS 的消费入口见 [openai-tts endpoint 索引](../endpoints/openai-tts.md)
