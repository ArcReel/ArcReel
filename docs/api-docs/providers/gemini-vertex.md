...
- 接口与能力：[generateContent API](https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1/projects.locations.publishers.models/generateContent)、[Generate images](https://cloud.google.com/vertex-ai/generative-ai/docs/image/generate-images)、[Veo video generation API](https://cloud.google.com/vertex-ai/generative-ai/docs/model-reference/veo-video-generation)
