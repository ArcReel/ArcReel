...
- 代码：`lib/config/registry.py::PROVIDER_REGISTRY["kling"]`、`lib/backends/image_backends/kling.py::KlingImageBackend`、`lib/backends/video_backends/kling.py::KlingVideoBackend`
