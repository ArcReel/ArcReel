...
- 代码：`lib/config/registry.py::PROVIDER_REGISTRY["minimax"]`、`lib/text_backends/openai.py::OpenAITextBackend`、`lib/image_backends/minimax.py::MiniMaxImageBackend`、`lib/custom_provider/builtin_endpoints/minimax-{hailuo-v1,hailuo-v1-fast,s2v-01,h3}.json`
