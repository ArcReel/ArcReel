...
- 代码：`lib/config/registry.py::PROVIDER_REGISTRY["agnes"]`、`lib/text_backends/agnes.py`、`lib/image_backends/agnes.py`、`lib/video_backends/agnes.py`、`lib/agnes_shared.py`
