...
- 计费：[Vidu billing](https://platform.vidu.cn/billing)
- 代码：`lib/custom_provider/endpoints.py::ENDPOINT_REGISTRY["vidu-video"]`、`lib/backends/video_backends/vidu.py::ViduVideoBackend`
