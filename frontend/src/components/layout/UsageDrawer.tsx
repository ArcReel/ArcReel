...
// ---------------------------------------------------------------------------
// UsageDrawer — cost breakdown drawer panel
// ---------------------------------------------------------------------------
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-gray-800 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium text-gray-200">Cost breakdown</h3>
        </div>
        <button
          type="button"
          onClick={onClose}
      ...
      <div className="max-h-72 overflow-y-auto">
        {callsLoading ? (
          ...
          <div className="flex items-center justify-center py-8 text-xs text-gray-500">No call records</div>
        ) : (
              ...
              return (
                <li key={call.id} className="px-4 py-2.5">
                  ...
                  <div className="mt-0.5 flex items-center gap-2 pl-5.5 text-[10px] text-gray-500">
                    ...
                    {call.call_type === "text" ? (
                      <>
                        {call.input_tokens != null && <span>in {call.input_tokens.toLocaleString()}</span>}
                        {call.output_tokens != null && <span>out {call.output_tokens.toLocaleString()} tokens</span>}
                      </>
                    ) : (
                      <>
