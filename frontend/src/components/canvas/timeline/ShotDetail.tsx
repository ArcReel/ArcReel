...
export function ShotDetail({
      ...
      {isAd && hasNarrationText && (
        <div>
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, var(--color-surface-3), var(--color-surface-3))",
              border: "1px solid var(--color-hairline-soft)",
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse at top, var(--color-surface-3), var(--color-surface-2))",
      }}
    >
      <div
      ...
      {dirty && (
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, var(--color-accent-dim), var(--color-surface-3))",
        ...
        >
          ...
          <button
            ...
            disabled={saving}
            className="focus-ring inline-flex items-center gap-1.5 rounded-md px-2.5 py-1 text-[11.5px] text-[var(--color-text-3)] transition-colors [&:not(:disabled)]:hover:bg-[var(--color-surface-2)] [&:not(:disabled)]:hover:text-[var(--color-text)] disabled:cursor-not-allowed disabled:opacity-50"
            style={{
              border: "1px solid var(--color-hairline)",
              background: "var(--color-surface-3)",
            }}
