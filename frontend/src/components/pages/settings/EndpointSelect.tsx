...
import { ChevronDown, Type, Image as ImageIcon, Film, Music } from "lucide-react";
...
const MEDIA_META: Record<MediaType, { Icon: typeof Type; labelKey: string }> = {
  ...
  audio: { Icon: Music, labelKey: "endpoint_audio_group" },
};

const MEDIA_ORDER: MediaType[] = ["text", "image", "video", "audio"];
