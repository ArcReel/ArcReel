...
export default {
  ...
  'step_step1_content': 'Chia nội dung',
  'step_step1_review': 'Duyệt bản chia',
  'step_final_script': 'Kịch bản chính thức',
  'step_asset_sheets': 'Ảnh tham chiếu tài nguyên',
  ...
  'action_repair_project_data': 'nhờ trợ lý sửa tệp dự án bị hỏng',
  ...
  'action_prepare_step1': 'chuẩn bị bản chia nội dung cho tập này',
  'action_confirm_step1': 'duyệt và xác nhận bản chia nội dung',
  'action_generate_script': 'tạo kịch bản chính thức',
  'action_generate_asset_sheets': 'tạo các ảnh tham chiếu tài nguyên còn thiếu',
  'action_generate_storyboards': 'tạo các ảnh phân cảnh còn thiếu',
  'action_generate_grid': 'tạo lưới phân cảnh',
