...
export default {
  ...
  'step_step1_content': 'Tổ chức nội dung',
  'step_step1_review': 'Xác nhận nội dung',
  ...
  'step_reference_keyframes': 'Khung hình chính tham chiếu',
  'step_narration_delivery': 'Cách đưa lời dẫn',
  'step_video_prompt_optimization': 'Tối ưu lời nhắc H3',
  'step_video': 'Video',
  ...
  'task_type_reference_keyframe': 'Khung hình chính tham chiếu',
  ...
  'action_generate_reference_storyboard_sheets': 'tạo Video Unit Storyboard Sheet còn thiếu',
  'action_confirm_reference_storyboard_sheet': 'xem xét và xác nhận Video Unit Storyboard Sheet hiện tại',
  'action_generate_reference_keyframes': 'tạo các khung hình chính tham chiếu còn thiếu',
  ...
  'problem_h3_prompt_missing': 'Chưa tạo lời nhắc H3 đã tối ưu.',
  'problem_h3_prompt_stale': 'Lời nhắc H3 không còn khớp với yêu cầu hiện tại và cần tối ưu lại.',
  'problem_h3_prompt_pending_review': 'Lời nhắc H3 đang chờ duyệt và xác nhận.',
  'problem_reference_keyframe_images_required': 'Một số ảnh khung hình đầu tiên đã lập kế hoạch vẫn còn thiếu.',
