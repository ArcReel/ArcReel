...
export default {
  ...
  'route_reference_video_desc': 'Tạo và xác nhận Video Unit Storyboard Sheet, sau đó tạo keyframe và dùng chúng cùng ảnh tài sản làm tham chiếu video',
  ...
  'reference_storyboard_sheet_generating': 'Đang tạo Video Unit Storyboard Sheet…',
  'reference_storyboard_sheet_not_generated': 'Video Unit Storyboard Sheet chưa được tạo',
  'reference_storyboard_sheet_help': 'Sheet này mô tả thứ tự cảnh quay và thay đổi bối cảnh của toàn bộ Video Unit. Phải xác nhận Sheet hiện tại trước khi tạo các khung hình chính.',
  'reference_storyboard_sheet_generate': 'Tạo Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_regenerate': 'Tạo lại Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirm_and_generate': 'Xác nhận Video Unit Storyboard Sheet và tạo khung hình chính',
  'reference_keyframe_storyboard_gate': 'Hãy tạo và xác nhận Storyboard Sheet của Video Unit này trước khi tạo khung hình chính.',
  ...
  'tool_name_generate_reference_storyboard_sheets': 'Tạo Video Unit Storyboard Sheet',
  'tool_name_confirm_reference_storyboard_sheet': 'Xác nhận Video Unit Storyboard Sheet và tạo keyframe',
