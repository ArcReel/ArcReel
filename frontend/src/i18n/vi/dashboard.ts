...
export default {
  ...
  'video_style_visual_treatment': 'Xử lý hình ảnh động',
  'video_style_visual_treatment_placeholder': 'Ví dụ: phim tài liệu thủ công chân thực với vật liệu tự nhiên và ánh sáng ấm',
  'video_style_camera_language': 'Ngôn ngữ máy quay',
  'video_style_camera_language_placeholder': 'Ví dụ: cận cảnh macro, chuyển động chậm ổn định, không rung mạnh',
  'video_style_pacing': 'Nhịp độ',
  'video_style_pacing_placeholder': 'Ví dụ: cảnh dài, ít cắt, trình bày trọn vẹn thao tác',
  'video_style_sound_focus': 'Trọng tâm âm thanh',
  'video_style_sound_focus_balanced': 'Cân bằng',
  'video_style_sound_focus_asmr': 'ASMR',
  'video_style_sound_focus_dialogue': 'Lời thoại',
  'video_style_sound_focus_ambience': 'Âm thanh môi trường',
  'video_style_sound_focus_silent': 'Im lặng',
  'video_style_music_policy': 'Nhạc nền',
  'video_style_music_policy_auto': 'Tự động quyết định',
  'video_style_music_policy_none': 'Không có nhạc nền',
  'video_style_music_policy_custom': 'Hướng nhạc tùy chỉnh',
  'video_style_music_description': 'Hướng âm nhạc',
  'video_style_music_description_placeholder': 'Mô tả nhạc cụ, nhịp độ và diễn biến cảm xúc',
  'video_style_sound_design': 'Thiết kế âm thanh',
  'video_style_sound_design_placeholder': 'Ví dụ: nhấn mạnh tiếng cạo dây, nhíp, men đổ và đá mài',
  'video_style_additional_instructions': 'Yêu cầu khác cho toàn dự án',
  'video_style_additional_instructions_placeholder': 'Chỉ nhập yêu cầu áp dụng cho mọi đơn vị video',
  ...
  'reference_keyframe_add_placeholder': 'Mô tả khung hình đầu tiên sau khi chuyển sang cảnh cốt lõi này',
