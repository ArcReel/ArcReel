...
export default {
  ...
  'asset_checklist_title': 'Danh sách tài nguyên',
  'asset_checklist_hint': 'Mở từng mục bên dưới để đăng ký nhân vật, bối cảnh và đạo cụ, giúp các cảnh quay được tạo ra giữ được sự nhất quán hình ảnh.',
  'generate_prompt_dialog_title': 'Xác nhận tạo',
  'generate_prompt_dialog_prompt_label': 'Prompt (có thể chỉnh sửa)',
  'generate_prompt_dialog_aspect_ratio_label': 'Tỷ lệ khung hình',
  'generate_prompt_dialog_aspect_ratio_default': 'Mặc định (16:9)',
  'generate_prompt_dialog_image_size_label': 'Chất lượng',
  'generate_prompt_dialog_image_size_default': 'Mặc định dự án',
  'generate_prompt_dialog_loading': 'Đang tải prompt…',
  'generate_prompt_dialog_load_failed': 'Tải prompt thất bại: {{message}}',
  'generate_prompt_dialog_retry': 'Thử lại',
  'generate_prompt_dialog_confirm': 'Tạo',
