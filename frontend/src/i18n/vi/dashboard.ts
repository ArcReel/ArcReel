...
export default {
  ...
  'reference_duration_batch_more': 'Còn {{count}} đơn vị khác cũng không khớp.',
  'reference_duration_precheck_failed': 'Không kiểm tra được thời lượng của {{count}} đơn vị, chưa đưa vào hàng đợi. Vui lòng thử lại.',
