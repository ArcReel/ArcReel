...
export default {
  ...
  'external_agent_install_command_desc': 'Chạy lệnh này trong terminal để cài đặt kiến thức thiết lập và quy trình sản xuất.',
  'external_agent_copy_install_command': 'Sao chép lệnh cài đặt',
  'external_agent_install_command_copied': 'Đã sao chép lệnh cài đặt.',
