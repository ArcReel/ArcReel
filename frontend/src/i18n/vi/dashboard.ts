...
export default {
  ...
  'ai_providers': 'Nhà cung cấp AI',
  'ai_providers_desc': 'Quản lý nhà cung cấp AI cho trợ lý. Kéo thả hoặc dùng mũi tên để sắp xếp thứ tự ưu tiên. Hệ thống tự động fallback sang nhà cung cấp tiếp theo nếu lỗi.',
  'add_provider': 'Thêm nhà cung cấp',
  'no_providers': 'Chưa có nhà cung cấp nào. Nhấn "Thêm nhà cung cấp" để bắt đầu.',
  'active': 'ĐANG DÙNG',
  'set_active': 'Đặt làm chính',
  'edit': 'Sửa',
  'delete': 'Xóa',
  'cannot_delete_active': 'Không thể xóa nhà cung cấp đang dùng',
  'test_connection': 'Kiểm tra kết nối',
  'test_ok': 'Kết nối thành công',
  'test_warn': 'Kết nối được, nhưng discovery endpoint lỗi',
  'test_fail': 'Không thể kết nối',
  'fallback_hint': '💡 Mẹo: Kéo thả để sắp xếp thứ tự ưu tiên. Nhà cung cấp ở trên sẽ được thử trước.',
  'priority_saved': 'Đã lưu thứ tự ưu tiên',
  'assistant_provider': 'Nhà cung cấp trợ lý',
  'assistant_provider_desc': 'Chọn nhà cung cấp AI cho trợ lý. Claude Agent SDK hỗ trợ sandbox code; LiteLLM hỗ trợ 100+ nhà cung cấp LLM.',
  'openai_compatible': 'Tương thích OpenAI',
  'openai_compatible_desc': 'Kết nối trực tiếp đến server tương thích OpenAI API (vllm, ollama, text-generation-webui, v.v.)',
  'credentials_section_desc': 'Quản lý API keys cho các nhà cung cấp media (video, hình ảnh, văn bản).',
  'select_model': 'Chọn mô hình...',
  'max_tool_rounds': 'Số vòng tool tối đa',
  'api_key_configured': 'API key đã được cấu hình',
  ...
  'generation_concurrency': 'Song song tạo media',
  'generation_concurrency_desc': 'Số lượng ảnh/video được tạo cùng lúc. Giá trị thấp = ổn định hơn, giá trị cao = nhanh hơn. Thay đổi sẽ có hiệu lực ngay lập tức.',
  'image_max_workers': 'Số ảnh cùng lúc',
  'image_max_workers_hint': 'Số ảnh tối đa được tạo đồng thời (1-10). Đặt 1 nếu máy yếu.',
  'video_max_workers': 'Số video cùng lúc',
  'video_max_workers_hint': 'Số video tối đa được tạo đồng thời (1-10). Đặt 1 nếu máy yếu.',
  ...
  'comfyui_settings': 'Cài đặt ComfyUI',
  'comfyui_sampler': 'Sampler',
  'comfyui_steps': 'Steps',
  'comfyui_cfg': 'CFG Scale',
  'comfyui_negative_prompt': 'Negative Prompt',
  'comfyui_clip_skip': 'Clip Skip',
  'comfyui_settings_hint': 'Để trống để dùng giá trị mặc định. Thay đổi sẽ được áp dụng khi tạo ảnh.',
  'comfyui_negative_prompt_placeholder': 'bad quality, blurry, ...',
  'comfyui_overrides': 'Ghi đè ComfyUI',
  'comfyui_overrides_desc': 'Ghi đè cài đặt ComfyUI toàn cục cho dự án này. Để trống để dùng cài đặt toàn cục.',
  'comfyui_project_override_hint': 'Các cài đặt này sẽ ghi đè cài đặt mô hình toàn cục chỉ cho dự án này.',
  'use_global_settings': 'Dùng cài đặt toàn cục',
  'default': 'Mặc định',
  'test_connection': 'Kiểm tra kết nối',
  ...
  'discovery_format_comfyui': 'ComfyUI (Cục bộ)',
  ...
  'endpoint_comfyui_image_display': 'ComfyUI Ảnh',
  'endpoint_comfyui_video_display': 'ComfyUI Video',
  'endpoint_comfyui_audio_display': 'ComfyUI Âm thanh',
  'endpoint_fal_image_display': 'fal.ai Hình ảnh',
  'endpoint_fal_video_display': 'fal.ai Video',
  'endpoint_fal_audio_display': 'fal.ai Âm thanh (TTS/Nhạc)',
