...
export default {
  ...
  'subagent_desc': 'Mô hình dùng khi tác nhân con thực thi song song',
  ...
  'subagent_card_label': 'Tác nhân con',
  ...
  'task_progress_started': 'Bắt đầu tác nhân con: {{description}}',
  'task_progress_completed': 'Tác nhân con hoàn thành',
  'task_progress_failed': 'Tác nhân con thất bại',
  'task_progress_ended': 'Tác nhân con kết thúc',
