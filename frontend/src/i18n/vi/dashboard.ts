...
export default {
  ...
  'no_audio_providers_hint': 'Không có nhà cung cấp audio khả dụng, vui lòng cấu hình khóa API tại "Nhà cung cấp" trước.',
  ...
  'audio_provider_not_configured_toast': 'Vui lòng cấu hình nhà cung cấp audio trước: thêm nhà cung cấp hỗ trợ chuyển văn bản thành giọng nói trong Cài đặt → Nhà cung cấp',
