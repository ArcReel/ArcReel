...
export default {
  ...
  'speech_rate_hint': 'Quy đổi độ dài lời thoại thành số giây cho gợi ý thời lượng, cảnh báo lượng thoại và canh giờ phụ đề. Để trống để ước tính theo nhịp mặc định của ngôn ngữ dự án. Không liên quan đến tốc độ giọng đọc.',
