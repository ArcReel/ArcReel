...
export default {
  ...
  'preprocessing': 'Kế hoạch kịch bản',
  ...
  'agent_access_kicker': 'Truy cập Agent',
  ...
  'character_voice_binding_prompt_label': 'Theo mô tả giọng',
  'character_voice_binding_reference_audio_label': 'Theo âm thanh tham chiếu',
  'character_voice_binding_prompt_desc': 'Đưa mô tả giọng của nhân vật vào câu lệnh để mô hình video lồng tiếng theo mô tả đó. Dễ thiết lập và không chiếm hạn mức tài nguyên tham chiếu, nhưng cùng một nhân vật chỉ có giọng gần giống nhau giữa các đoạn.',
  'character_voice_binding_reference_audio_desc': 'Tải lên hoặc tạo âm thanh tham chiếu cho từng nhân vật và gửi kèm mỗi yêu cầu để mô hình video dùng lại đúng chất giọng đó. Nhất quán nhất giữa các đoạn, nhưng mọi nhân vật có thoại đều cần âm thanh tham chiếu và sẽ chiếm hạn mức âm thanh tham chiếu của mô hình.',
  'character_voice_binding_optional_hint': 'Dự án này lồng tiếng nhân vật theo mô tả nên âm thanh tham chiếu chưa có tác dụng. Để bật, hãy đổi cách ràng buộc giọng nhân vật sang «Theo âm thanh tham chiếu» trong cài đặt dự án.',
  ...
  'prompt_preview_saved_only': 'Kết xuất từ kịch bản đã lưu — đúng từng chữ như văn bản gửi tới mô hình.',
  'prompt_preview_saved_only_dirty': 'Bạn có thay đổi chưa lưu; bản xem trước vẫn theo kịch bản đã lưu.',
  ...
  'preprocessing_tab': 'Kế hoạch kịch bản',
  ...
  'loading_preprocessing': 'Đang tải kết quả kế hoạch kịch bản...',
  'no_preprocessing_content': 'Không có kết quả kế hoạch kịch bản',
  ...
  'reference_tab_preprocess': 'Kế hoạch kịch bản',
  ...
  'tab_preprocessing': 'Kế hoạch kịch bản',
  ...
  'ce_import_relation_newer': 'Bản hiện có mới hơn',
  'ce_import_relation_same': 'Cùng phiên bản',
  'ce_import_relation_older': 'Bản hiện có cũ hơn',
  'ce_import_schema_mismatch': 'Tệp dùng định dạng phiên bản {{file}}; phiên bản hiện tại đọc {{current}}.',
  ...
  'ce_path_add': '+ Đường dẫn dự phòng',
