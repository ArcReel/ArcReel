...
export default {
  ...
  'speech_rate_label': 'Nhịp đọc dùng để ước tính (tùy chọn)',
  'speech_rate_hint_language_pending': 'Ngôn ngữ dự án chưa được xác định, và đơn vị đọc phụ thuộc vào nó: ký tự cho tiếng Trung, từ cho tiếng Anh và tiếng Việt. Bạn có thể điều chỉnh trong cài đặt dự án sau khi ngôn ngữ được xác định.',
  'speech_rate_hint': 'Quy đổi độ dài nội dung nói (lời thoại và lời dẫn) thành số giây cho gợi ý thời lượng, cảnh báo lượng thoại và canh giờ phụ đề. Để trống để ước tính theo nhịp mặc định của ngôn ngữ dự án. Không liên quan đến tốc độ giọng đọc.',
  'speech_rate_out_of_range': 'Phải nằm trong khoảng {{min}} đến {{max}}',
  'reading_unit_char_per_second': 'ký tự/giây',
  'reading_unit_generic_per_second': 'đơn vị đọc/giây',
