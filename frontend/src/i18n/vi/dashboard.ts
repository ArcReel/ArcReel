...
export default {
  ...
  'chat_role_user': 'Bạn',
  'chat_role_assistant': 'Tác nhân AI',
  'chat_role_system': 'Hệ thống',
  'chat_role_message': 'Tin nhắn',
  'agent_sdk_desc': 'Được hỗ trợ bởi Claude Agent SDK, vận hành tác nhân AI hội thoại và quy trình tự động',
  ...
  'model_routing_desc': 'Cấu hình mô hình theo độ phức tạp của tác vụ tác nhân AI.',
  ...
  'session_control_desc': 'Kiểm soát tài nguyên và vòng đời phiên cho các tác nhân AI đang chạy.',
  ...
  'max_sessions_desc': 'Số tác nhân AI tối đa được phép chạy đồng thời',
  ...
  'agent_handoff_subtitle': 'Trò chuyện với tác nhân AI để bắt đầu sản xuất video.',
  ...
  'products': 'Hàng hóa',
  'product_design': 'Ảnh tham chiếu hàng hóa',
  ...
  'remove_image': 'Bỏ ảnh',
  'assistant_input': 'Ô nhập tác nhân AI',
  ...
  'product_task_submitted_toast': 'Đã gửi tác vụ tạo ảnh tham chiếu cho hàng hóa "{{name}}"',
  ...
  'anthropic_key_required_desc': 'Khóa API Anthropic là bắt buộc để tác nhân AI hoạt động',
  ...
  'model_config_desc': 'Chỉ định các mô hình Claude cho tác nhân AI. Để trống để dùng mặc định của Claude Agent SDK.',
  ...
  'max_concurrent_sessions_desc': 'Số phiên tác nhân AI hoạt động tối đa. Phiên vượt quá sẽ tự giải phóng các phiên ít dùng nhất (phiên đã dọn dẹp được lưu trữ và khôi phục ở lượt trò chuyện kế tiếp).',
  ...
  'episodes_title': 'Tập',
  'no_episodes_ai_hint': 'Chưa có tập nào. Dùng tác nhân AI để tạo kịch bản.',
  ...
  'agent_profile_reset_confirm_description': 'Các tệp tùy chỉnh sau sẽ bị loại bỏ và thay bằng hồ sơ tích hợp hiện tại. Không thể hoàn tác thao tác này. Các phiên tác nhân AI đang mở vẫn dùng cấu hình hiện tại cho đến khi kết nối lại.',
  ...
  'reference_step1_quarantined_unit_hint': 'Đơn vị video này đang được tác nhân AI sửa trên bản nháp, giao diện sẽ cập nhật sau khi được thăng cấp.',
  ...
  'reference_step1_request_fix': 'Nhờ tác nhân AI sửa',
  ...
  'episode_workspace_no_episode': 'Tập này chưa được bắt đầu. Hãy bắt đầu từ kịch bản, hoặc để tác nhân AI phác thảo cho bạn.',
  ...
  'open_assistant_panel': 'Mở bảng tác nhân AI',
  'resize_assistant_panel': 'Điều chỉnh chiều rộng bảng tác nhân AI (nhấp đúp để đặt lại)',
  ...
  'migration_repair_body': 'Nâng cấp dữ liệu chưa hoàn tất nên chức năng tạo nội dung tạm thời bị tắt. Kịch bản và hình ảnh đã có vẫn xem được bình thường. Nhấn "Thử lại nâng cấp" để đưa yêu cầu sửa vào cuộc trò chuyện với tác nhân AI, rồi tự bạn gửi đi.',
  ...
  'ad_init_generate_sheet_label': 'Tạo ảnh tham chiếu hàng hóa chuẩn',
  'ad_init_generate_sheet_hint': 'Chuyển ảnh chụp thường thành bản thiết kế đa góc chuẩn; xem xét và tạo lại trên trang hàng hóa',
