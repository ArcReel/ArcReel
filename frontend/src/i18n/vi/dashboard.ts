...
export default {
  ...
  'reference_duration_confirm_title': 'Thời lượng tạo không khớp với mốc thời lượng yêu cầu',
  ...
  'reference_duration_note_longer': 'Mô hình chỉ nhận các mức thời lượng cố định. Video được giao đúng thời lượng đã yêu cầu và không bị cắt về mốc thời lượng yêu cầu.',
  ...
  'reference_duration_batch_summary': '{{count}} đơn vị sẽ dùng mức tạo không khớp với mốc thời lượng yêu cầu:',
