...
export default {
  ...
  'agent_access_desc': 'Dùng Agent tích hợp hoặc kết nối Agent bên ngoài bạn ưa thích; chỉ cần chọn một cách để bắt đầu sáng tạo.',
  ...
  'external_agent_desc': 'Kết nối trực tiếp Agent bên ngoài bạn ưa thích với [[brand]] mà không cần cấu hình thông tin xác thực cho Agent tích hợp.',
  ...
  'tool_name_validate_and_promote_draft': 'Hoàn tất xử lý bản nháp',
