...
export default {
  ...
  'need_storyboard_first': 'Hãy tạo phân cảnh trước',
  'generate_video_btn': 'Tạo video',
  'generate_video_first_last': 'Tạo video (first_last)',
  ...
  'cred_list_empty': 'Chưa có xác thực nào. Nhấn "Thêm xác thực" để bắt đầu.',
  ...
  'cred_edit_coming_soon': 'Tính năng chỉnh sửa sắp ra mắt',
