...
export default {
  ...
  'openai_model_sync_status': 'Đã tìm thấy {{count}} mô hình văn bản khả dụng từ OpenAI và hợp nhất với danh mục tích hợp.',
  ...
  'asset_prompt_scene_label': 'Prompt thư viện cảnh',
  'asset_prompt_prop_label': 'Prompt thư viện đạo cụ',
  'asset_prompt_restore_default': 'Khôi phục mặc định tích hợp',
  'asset_prompt_merge_hint': 'Mô tả người dùng nhập cho tài sản được giữ nguyên và gửi đến mô hình ảnh cùng với prompt hệ thống này.',
  'media_config_saved': 'Đã lưu cấu hình mô hình media',
  'asset_prompts_saved': 'Đã lưu cấu hình prompt tài sản',
