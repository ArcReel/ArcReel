...
export default {
  ...
  'reference_batch_confirm_intro_one': '{{count}} đơn vị sẽ được tạo theo mức thời lượng dưới đây; xác nhận sẽ đưa tất cả vào hàng đợi:',
  'reference_batch_confirm_intro_other': '{{count}} đơn vị sẽ được tạo theo các mức thời lượng dưới đây; xác nhận sẽ đưa tất cả vào hàng đợi:',
  'reference_batch_tier_units_one': '{{count}} đơn vị',
  'reference_batch_tier_units_other': '{{count}} đơn vị',
  'reference_batch_tier_cost': 'Tổng {{cost}}',
  'reference_batch_tier_cost_unknown': 'Chưa có tổng chi phí',
  'reference_batch_tier_unknown': 'chưa xác định mức',
  'reference_batch_unit_tiers': 'Hiện tại {{current}} → yêu cầu {{request}}',
  ...
  'reference_batch_blocked_intro': 'Không có tác vụ nào được tạo. Hãy xử lý các đơn vị dưới đây rồi chạy lại.',
  'reference_batch_withheld_title_one': 'Còn {{count}} đơn vị không có vấn đề riêng nhưng cũng chưa được gửi cùng loạt này:',
  'reference_batch_withheld_title_other': 'Còn {{count}} đơn vị không có vấn đề riêng nhưng cũng chưa được gửi cùng loạt này:',
  'reference_batch_skipped_one': '{{count}} đơn vị đã có video nên được bỏ qua',
  'reference_batch_skipped_other': '{{count}} đơn vị đã có video nên được bỏ qua',
  ...
  'reference_batch_action_retry': 'Tiếp theo: thử lại sau ít phút',
  'reference_batch_action_resume': 'Tiếp theo: tiếp tục đơn vị này',
  'reference_batch_action_fix_input': 'Tiếp theo: xem lại và sửa cấu hình tạo của đơn vị này',
  'reference_batch_action_generate_dependency': 'Tiếp theo: bổ sung hoặc thay thế tài nguyên tham chiếu bị thiếu',
  'reference_batch_action_generate_tts': 'Tiếp theo: tạo lời dẫn cho đơn vị này',
  'reference_batch_action_regenerate_tts': 'Tiếp theo: tạo lại lời dẫn cho đơn vị này',
  'reference_batch_action_wait_for_task': 'Tiếp theo: chờ tác vụ đang chạy kết thúc rồi thử lại',
  'reference_batch_action_replan_unit': 'Tiếp theo: lập lại kế hoạch cho đơn vị này',
  'reference_batch_action_confirm_request_duration': 'Tiếp theo: xác nhận mức thời lượng yêu cầu',
  'reference_batch_action_configure_provider': 'Tiếp theo: đổi hoặc cấu hình mô hình video trong cài đặt',
  'reference_batch_action_repair_artifact_state': 'Tiếp theo: sửa trạng thái sản phẩm của đơn vị này',
