...
export default {
  ...
  'reference_batch_action_repair_reference_declaration': 'Tiếp theo: sửa khai báo tham chiếu của đơn vị này',
  'reference_batch_action_repair_reference_assets': 'Tiếp theo: bổ sung hoặc thay thế tài nguyên tham chiếu bị thiếu',
  'reference_batch_action_review_reference_selection': 'Tiếp theo: xem lại số ảnh mà đơn vị này tham chiếu',
  'reference_batch_action_enable_model_audio': 'Tiếp theo: chỉnh công tắc âm thanh của mô hình video trong cài đặt',
  'reference_batch_action_confirm_duration': 'Tiếp theo: xác nhận mức thời lượng yêu cầu',
  ...
  'reference_batch_action_configure_video_model': 'Tiếp theo: đổi hoặc cấu hình mô hình video trong cài đặt',
  'reference_batch_action_review_request_configuration': 'Tiếp theo: xem lại cấu hình tạo của đơn vị này',
