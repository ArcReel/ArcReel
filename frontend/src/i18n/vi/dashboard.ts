...
export default {
  ...
  'review_fix_request_prefill_header':
    'Bản nháp tổ chức nội dung của tập {{episode}} có {{count}} vi phạm cần sửa; hãy gọi open_draft với doc_type={{docType}} để đọc, sau đó sửa bằng patch_draft với cùng doc_type và truyền revision trả về làm base_revision:',
  ...
  'reference_step1_confirm_blocked_hint': 'Còn vi phạm chặn — chỉ xác nhận được sau khi Agent sửa xong',
  ...
  'reference_step1_fix_request_prefill_header':
    'Bản nháp tổ chức nội dung video từ ảnh tham chiếu của tập {{episode}} có {{count}} vi phạm cần sửa; hãy gọi open_draft với doc_type=reference_step1 để đọc, sau đó sửa bằng patch_draft với cùng doc_type và truyền revision trả về làm base_revision:',
  ...
  'external_agent_mcp_endpoint_desc': 'Dùng URL này trong cấu hình MCP của Agent bên ngoài.',
  'external_agent_copy_mcp_endpoint': 'Sao chép endpoint MCP',
  'external_agent_mcp_endpoint_copied': 'Đã sao chép endpoint MCP.',
  'external_agent_api_key_desc': 'Tạo API Key arc-, sau đó sao chép và lưu ngay.',
  'external_agent_manage_api_keys': 'Tạo hoặc sao chép API Key',
  'external_agent_install_command': 'Cài đặt ArcReel skills',
  'external_agent_install_command_desc': 'Chạy cả hai lệnh trong terminal để cài đặt kiến thức thiết lập và quy trình sản xuất.',
  'external_agent_copy_install_command': 'Sao chép các lệnh cài đặt',
  'external_agent_install_command_copied': 'Đã sao chép các lệnh cài đặt.',
  'external_agent_copy_failed': 'Sao chép thất bại. Hãy chọn và sao chép nội dung ở trên theo cách thủ công.',
  'external_agent_install_guide': 'Hướng dẫn cài đặt',
  'external_agent_install_guide_desc': 'Làm theo hướng dẫn để cấu hình client, thêm API Key và xác minh kết nối.',
  'external_agent_view_install_guide': 'Xem hướng dẫn cài đặt đầy đủ',
  ...
  'tool_name_get_step1_content': 'Đọc nội dung bước 1',
  ...
  'tool_name_generate_step1': 'Tạo cấu trúc nội dung',
