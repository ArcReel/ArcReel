...
export default {
  ...
  'import_recent_workflows': 'Nhập quy trình gần đây',
  'importing_workflows': 'Đang nhập quy trình...',
  ...
  'model_display_name_label': 'Tên hiển thị',
  'model_display_name_placeholder': 'Nhập tên mô hình dễ nhận biết',
  'workflow_name_label': 'Tên quy trình',
  'workflow_name_placeholder': 'Ví dụ: MiniMax H3 · Video đa phương thức',
  ...
  'comfyui_discovery_empty_hint': 'Hãy chạy thành công quy trình video đích trong ComfyUI, sau đó nhấn "Nhập quy trình gần đây".',
  'comfyui_api_key_optional': 'Không bắt buộc; chỉ cần khi proxy ngược phía trước ComfyUI dùng xác thực Bearer Token.',
  'comfyui_discovery_help': 'Nhập quy trình video có thể tái sử dụng từ các tác vụ ComfyUI thành công gần đây',
  ...
  'discovery_format_comfyui': 'Quy trình ComfyUI',
  ...
  'endpoint_comfyui_workflow_display': 'Quy trình video ComfyUI',
