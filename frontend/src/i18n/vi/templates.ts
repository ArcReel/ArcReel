...
export default {
  ...
  bucket_i2i_caption: "Tác vụ chỉnh sửa ảnh cũng dùng mô hình ảnh sang ảnh.",
  bucket_i2v_label: "Ảnh sang video",
  bucket_i2v_caption: "Bao gồm video được tạo từ khung phân cảnh hoặc khung phân cảnh đa ô, cùng các cảnh tham chiếu sang video không có ảnh tham chiếu.",
  bucket_r2v_label: "Tham chiếu sang video",
  bucket_r2v_caption: "Bao gồm các cảnh tham chiếu sang video có ảnh tham chiếu.",
