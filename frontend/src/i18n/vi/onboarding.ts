...
export default {
  ...
  'workbench_overview_title': 'Toàn cảnh dự án nằm ở canvas tổng quan',
  'workbench_overview_body': 'Thẻ dự án mẫu vừa rồi mở ra chính là đây. Phần trên là tổng quan câu chuyện — thể loại, chủ đề và thế giới quan do Agent viết ra sau khi đọc hết nguyên tác, sửa được bất cứ lúc nào. Phần dưới là dàn ý các tập, mỗi tập ghi trạng thái và tiến độ riêng.',
  'workbench_lorebook_title': 'Sổ tri thức quản lý nhân vật, bối cảnh và đạo cụ',
  'workbench_lorebook_body': 'Mỗi nhân vật có một thẻ riêng: ngoại hình, chất giọng và một ảnh tạo hình làm chuẩn cho mọi khung hình về sau. Bối cảnh và đạo cụ nằm cùng nhóm ở bên trái, cách dùng y hệt. Chốt thiết định trước rồi mới tạo phân cảnh thì hình ảnh mới không lệch nhau giữa các tập.',
  'workbench_timeline_title': 'Toàn bộ việc của một tập nằm trên canvas phân cảnh',
