...
export default {
  ...
  'asset_checklist_title': 'Asset checklist',
  'asset_checklist_hint': 'Open each entry below to register characters, scenes, and props so generated shots stay visually consistent.',
  'generate_prompt_dialog_title': 'Confirm generation',
  'generate_prompt_dialog_prompt_label': 'Prompt (editable)',
  'generate_prompt_dialog_aspect_ratio_label': 'Aspect ratio',
  'generate_prompt_dialog_aspect_ratio_default': 'Default (16:9)',
  'generate_prompt_dialog_image_size_label': 'Quality',
  'generate_prompt_dialog_image_size_default': 'Project default',
  'generate_prompt_dialog_loading': 'Loading prompt…',
  'generate_prompt_dialog_load_failed': 'Failed to load prompt: {{message}}',
  'generate_prompt_dialog_retry': 'Retry',
  'generate_prompt_dialog_confirm': 'Generate',
