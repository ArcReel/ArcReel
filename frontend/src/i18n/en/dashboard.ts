...
export default {
  ...
  'ai_providers_desc': 'Manage AI providers for the assistant. Drag and drop or use arrows to set priority order. The system automatically falls back to the next provider if one fails.',
  'add_provider': 'Add Provider',
  'no_providers': 'No providers yet. Click "Add Provider" to begin.',
  'active': 'ACTIVE',
  'set_active': 'Set active',
  'edit': 'Edit',
  'delete': 'Delete',
  'cannot_delete_active': 'Cannot delete the active provider',
  'test_connection': 'Test connection',
  'test_ok': 'Connected successfully',
  'test_warn': 'Connected, but discovery endpoint failed',
  'test_fail': 'Cannot connect',
  'fallback_hint': '💡 Tip: Drag and drop to set priority order. Providers at the top will be tried first.',
  'priority_saved': 'Priority order saved',
  'assistant_provider': 'Assistant Provider',
  'assistant_provider_desc': 'Choose the AI provider for the assistant. Claude Agent SDK offers sandboxed code execution; LiteLLM supports 100+ LLM providers.',
  'openai_compatible': 'OpenAI Compatible',
  'openai_compatible_desc': 'Connect directly to an OpenAI-compatible server (vllm, ollama, text-generation-webui, etc.)',
  'credentials_section_desc': 'Manage API keys for media providers (video, image, text).',
  ...
  'generation_concurrency_desc': 'Number of images/videos generated simultaneously. Lower values = more stable, higher values = faster. Changes take effect immediately.',
  'image_max_workers': 'Concurrent Images',
  'image_max_workers_hint': 'Maximum images generated in parallel (1-10). Set to 1 for weaker machines.',
  'video_max_workers': 'Concurrent Videos',
  'video_max_workers_hint': 'Maximum videos generated in parallel (1-10). Set to 1 for weaker machines.',
  ...
  'comfyui_settings': 'ComfyUI Settings',
  'comfyui_sampler': 'Sampler',
  'comfyui_steps': 'Steps',
  'comfyui_cfg': 'CFG Scale',
  'comfyui_negative_prompt': 'Negative Prompt',
  'comfyui_clip_skip': 'Clip Skip',
  'comfyui_settings_hint': 'Leave empty to use defaults. Changes will be applied when generating images.',
  'comfyui_negative_prompt_placeholder': 'bad quality, blurry, ...',
  'comfyui_overrides': 'ComfyUI Overrides',
  'comfyui_overrides_desc': 'Override global ComfyUI settings for this project. Leave empty to use global defaults.',
  'comfyui_project_override_hint': 'These settings override the global model settings for this project only.',
  ...
  'endpoint_comfyui_image_display': 'ComfyUI Image',
  'endpoint_comfyui_video_display': 'ComfyUI Video',
  'endpoint_comfyui_audio_display': 'ComfyUI Audio',
  'endpoint_fal_image_display': 'fal.ai Image',
  'endpoint_fal_video_display': 'fal.ai Video',
  'endpoint_fal_audio_display': 'fal.ai Audio (TTS/Music)',
