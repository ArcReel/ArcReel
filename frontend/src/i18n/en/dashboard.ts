...
export default {
  ...
  'reference_step1_status_editable': 'Processing draft',
  'reference_step1_editable_hint': 'The agent is finishing the draft; this view updates automatically when it is done',
