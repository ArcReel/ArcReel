...
export default {
  ...
  'style_saved_to_library': 'Style saved and added to your custom styles',
  'style_saving': 'Saving…',
  'style_clear': 'Remove style',
  'style_cleared_hint': 'Save to remove the current style',
  'style_description_label': 'Style description',
  'style_description_hint': 'Enter a style prompt directly, or analyze the reference image above and then refine it.',
  'style_description_placeholder': 'Enter the style prompt used for future generations',
  'style_input_or': 'or enter it directly',
  'style_analyze': 'Analyze style',
  'style_analyzing': 'Analyzing…',
  'style_analysis_complete': 'Style analysis complete',
  'style_analysis_failed': 'Style analysis failed: {{message}}',
  'importing': 'Importing...',
  ...
  'subagent_model': 'Subtask Model',
  'subagent_desc': 'Model used when subtasks execute in parallel',
  ...
  'voice_sample_action': 'Generate character reference audio',
  'voice_sample_not_configured_hint': 'Configure a video or audio provider in settings first',
  'voice_sample_video_unavailable_tts_hint': 'Video generation is unavailable; use TTS for the reference audio',
  'voice_sample_modal_title': 'Generate voice reference sample',
  'voice_sample_modal_desc': 'Generate an approximately 10-second candidate for "{{name}}". Preview it, then confirm to save it as the character’s reference audio.',
  'voice_sample_mode_video': 'Video extraction (default)',
  'voice_sample_mode_tts': 'TTS voice',
  'voice_sample_video_mode_hint': 'A clean single-speaker monologue video is generated privately. Only its audio is kept; the video is never shown or retained.',
  ...
  'voice_sample_text_default':
    "Hello, I am {{name}}. This is my natural speaking voice. Please remember how I sound; I am glad to meet you in the story ahead.",
  'voice_sample_text_hint': 'The target is about 10 seconds. If 10 seconds is unsupported, the closest supported duration below it is used.',
  ...
  'image_model_project_default': 'Use project default model',
  ...
  'global_video_resolution_title': 'Default Video Resolution',
  'global_video_resolution_desc': 'Set a global default per model. Project settings take priority; leave unset to use the system-safe or provider default.',
  'global_video_resolution_aria': 'Default resolution for {{model}}',
  ...
  'auto_edit_hyperframes': 'Auto-edit with HyperFrames',
  'auto_edit_hyperframes_hint': 'Create a project-local edit and open the complete Studio editor',
  'hyperframes_workspace_ready': 'HyperFrames workspace is ready',
  'hyperframes_auto_edit_started': 'HyperFrames auto-edit was sent to the Agent; Studio will update live',
  'hyperframes_prepare_failed': 'Could not prepare HyperFrames: {{message}}',
  'hyperframes_instruction': 'Editing instruction (optional)',
  'hyperframes_instruction_hint': 'The Agent derives a plan from the final script, then applies these directions over its default pacing and style.',
  'hyperframes_instruction_placeholder': 'For example: keep the unit order, make the first three seconds punchier, use clean white captions, and avoid flashy transitions.',
  'hyperframes_background_music': 'Auto-configure background music',
  'hyperframes_background_music_hint': 'When appropriate, generate one continuous instrumental track on the in-house GPU at a fixed 15% volume.',
  'hyperframes_preparing': 'Preparing workspace…',
  'hyperframes_start_auto_edit': 'Start auto-edit',
  ...
  'character_catalog_token_configured': 'Configured: {{masked}}',
  'character_catalog_token_missing': 'No token configured',
  ...
  'video_style_section_title': 'Unified Video Style',
  'video_style_section_description': 'One project-wide audiovisual direction shared by every video unit and H3 prompt optimization.',
  'video_style_source_agent': 'Agent inferred',
  'video_style_source_user': 'User defined',
  'video_style_source_agent_hint': 'Inferred from the overview, visual style, and split scripts. You can edit it directly.',
  'video_style_source_user_hint': 'This configuration was edited by the user and will not be overwritten automatically.',
  'video_style_analyze': 'Analyze with Agent',
  'video_style_analyzing': 'Analyzing…',
  'video_style_analysis_complete': 'Unified project video style created',
  'video_style_existing_reused': 'Existing unified video style reused',
  'video_style_analysis_failed': 'Video style analysis failed: {{message}}',
  'video_style_save': 'Save video style',
  'video_style_saved': 'Unified video style saved',
  'video_style_save_failed': 'Could not save video style: {{message}}',
  'video_style_missing_hint': 'If left unset, it will be analyzed once before H3 generation.',
  ...
  'route_reference_video_desc': 'Create and confirm a Video Unit Storyboard Sheet, then generate keyframes and use them with asset images as video references',
  ...
  'reference_video_style_summary': 'Video style: {{summary}}',
  'reference_video_style_missing': 'Not set; analyze before generation',
  'reference_video_style_edit_aria': 'View or edit the unified project video style',
  ...
  'reference_editor_view_keyframes': 'Keyframes',
  'reference_editor_view_storyboard': 'Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_title': 'Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirmed_badge': 'Confirmed',
  'reference_storyboard_sheet_pending_badge': 'Awaiting confirmation',
  'reference_storyboard_sheet_generating': 'Generating Video Unit Storyboard Sheet…',
  'reference_storyboard_sheet_not_generated': 'Video Unit Storyboard Sheet has not been generated',
  'reference_storyboard_sheet_help': 'This sheet previews the shot order and scene changes for this entire Video Unit. Confirm the current sheet before key first frames can be generated.',
  'reference_storyboard_sheet_generate': 'Generate Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_regenerate': 'Regenerate Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirm_and_generate': 'Confirm Video Unit Storyboard Sheet and generate keyframes',
  'reference_keyframe_storyboard_gate': 'Generate and confirm this Video Unit’s Storyboard Sheet before generating keyframes.',
  ...
  'reference_keyframe_delete': 'Delete keyframe',
  'reference_keyframe_delete_confirm': 'Delete this keyframe and its manuscript reference?',
  'reference_keyframe_empty': 'No keyframes are defined for this video unit yet.',
  'reference_keyframe_add': 'Add key scene',
  'reference_keyframe_add_placeholder': 'Describe the static 00:00.000 entry frame, not the action outcome',
  ...
  'reference_picker_group_keyframe': 'Keyframes',
  ...
  'reference_picker_tab_keyframe': 'Keyframes',
  ...
  'reference_tab_h3_prompts': 'H3 prompts',
  'reference_tab_hyperframes': 'HyperFrames',
  'hyperframes_studio_title': 'HyperFrames Studio editor',
  'hyperframes_studio_starting': 'Starting HyperFrames Studio…',
  'hyperframes_studio_start_failed': 'HyperFrames Studio could not start',
  'hyperframes_retry': 'Retry',
  'hyperframes_open_new_window': 'Open in new window',
  'h3_prompt_title': 'MiniMax H3 video prompt',
  'h3_prompt_description': 'Automatically optimized from the final references, audio, duration, and model request.',
  'h3_prompt_units': 'Video units',
  'h3_prompt_refresh': 'Refresh prompt status',
  'h3_prompt_optimize': 'Optimize prompt',
  'h3_prompt_confirm': 'Confirm and release',
  'h3_prompt_empty': 'No optimized prompt has been generated yet.',
  'h3_prompt_auto_pending': 'The H3 prompt will be optimized automatically when video generation starts.',
  'h3_prompt_auto_running': 'The video generation pipeline is optimizing the H3 prompt…',
  'h3_prompt_ready_description': 'This video unit will use the H3 prompt below.',
  'h3_prompt_edit_label': 'Edit the MiniMax H3 video prompt',
  'h3_prompt_state_not_applicable': 'Not applicable',
  'h3_prompt_state_missing': 'Missing',
  'h3_prompt_state_stale': 'Stale',
  'h3_prompt_state_pending_review': 'Pending review',
  'h3_prompt_state_confirmed': 'Confirmed',
  ...
  'reference_batch_blocked_cta': 'Got it',
  ...
  'h3_progress_aria': 'MiniMax H3 video generation progress',
  'h3_progress_style': 'Analyze style',
  'h3_progress_optimize': 'Optimize prompt',
  'h3_progress_submitted': 'Submitted',
  'h3_progress_queued': 'Queued',
  'h3_progress_generating': 'Generate video',
  'h3_progress_style_detail': 'Analyzing the unified project video style…',
  'h3_progress_optimize_detail': 'Optimizing the prompt…',
  'h3_progress_submitted_detail': 'Task submitted',
  'h3_progress_queued_waiting': 'Queued; waiting for position…',
  'h3_progress_queued_detail': 'Queued with {{ahead}} ahead ({{total}} total)',
  'h3_progress_preparing_detail': 'Preparing generation assets…',
  'h3_progress_running_detail': 'Generating video {{progress}}%',
  'h3_progress_cancelling_detail': 'Cancelling the remote generation task…',
  'h3_progress_cancel': 'Cancel H3 generation',
  ...
  'review_saved': 'Content organization draft saved',
  ...
  'reference_step1_unit_text_label': '{{unit}} body',
  ...
  'tool_name_confirm_asset_sheets': 'Accept existing asset images',
  ...
  'tool_name_generate_reference_storyboard_sheets': 'Generate Video Unit Storyboard Sheets',
  'tool_name_confirm_reference_storyboard_sheet': 'Confirm Video Unit Storyboard Sheet and generate keyframes',
  'tool_name_generate_reference_keyframes': 'Generate reference keyframes',
  ...
  'tool_name_optimize_h3_video_prompts': 'Optimize H3 video prompts',
  'tool_name_update_h3_video_prompt': 'Update H3 video prompt',
  'tool_name_prepare_hyperframes_episode': 'Prepare HyperFrames edit',
  'tool_name_generate_hyperframes_bgm': 'Generate HyperFrames background music',
  ...
  'tool_name_analyze_video_style': 'Analyze unified video style',
  'tool_name_update_video_style': 'Edit unified video style',
  ...
  'skill_name_hyperframes_auto_edit': 'HyperFrames auto-edit',
  ...
  'ad_init_generate_sheet_hint': 'Turns casual photos into a standardized multi-angle asset sheet; review and regenerate on the merchandise page',
  ...
  'lobby_hero_greeting_morning': 'Good morning, friend.',
  'lobby_hero_greeting_noon': 'Good noon, friend.',
  'lobby_hero_greeting_afternoon': 'Good afternoon, friend.',
  'lobby_hero_greeting_evening': 'Good evening, friend.',
  'lobby_hero_greeting_late': 'Burning the midnight oil, friend.',
