...
export default {
  ...
  'video': 'Video',
  'actual': 'Actual',
  'character_and_clue': 'Char/Clue',
  'upload_style_image': 'Upload style image',
  'delete_style_image': 'Delete style image',
  'visual_style_reference': 'Visual style reference',
  ...
  // OverviewCanvas (restored original layout)
  'project_style_title': 'Project Style',
  'style_desc_hint': 'Reference image participates in subsequent visual generation; style description supplements visual rules, calibrating overall tone, material, and lens aesthetic.',
  'style_tag_unset': 'No style tag set',
  'uploading_style_image': 'Uploading...',
  'upload_style_reference': 'Upload style reference image',
  'supported_formats': 'Supports PNG / JPG / WEBP',
  'usage_guide': 'Usage Guide',
  'style_usage_with_image': 'The current reference image will serve as a unified visual baseline for character, storyboard, and video generation.',
  'style_usage_without_image': 'No project-level reference image bound yet. Upload a target style sample as a unified baseline.',
  'replace_reference': 'Replace Reference',
  'deleting_reference': 'Deleting...',
  'delete_reference': 'Delete Reference',
  'upload_style_ref_aria': 'Upload style reference image',
  'style_desc_char_count': '{{count}} chars',
  'style_desc_auto_hint': 'Style description is auto-analyzed after uploading reference image; you can also manually edit.',
  'style_desc_textarea_placeholder': 'After uploading, style description is auto-analyzed; you can also manually edit.',
  'style_tip_with_image': "It's recommended to use the style description to supplement lighting, color, material, and lens language.",
  'style_tip_without_image': 'Without a reference image, you can also use text to define the visual style and aesthetic constraints.',
  'save_style_description': 'Save Style Description',
  'style_desc_saved': 'Style description saved',
  'loading_project_data': 'Loading project data...',
  'narration_visuals_mode': 'Narration + Visuals',
  'drama_animation_mode': 'Drama Animation',
