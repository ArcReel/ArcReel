...
export default {
  ...
  'product_design': 'Merchandise Reference Sheet',
  ...
  'product_task_submitted_toast': 'Reference sheet task for merchandise "{{name}}" submitted',
  ...
  'ad_init_generate_sheet_label': 'Generate merchandise reference sheet',
  'ad_init_generate_sheet_hint': 'Turns casual photos into a standardized multi-angle sheet; review and regenerate on the merchandise page',
