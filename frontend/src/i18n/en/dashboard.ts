...
export default {
  ...
  'supported_durations_no_fps_hint': 'Frames is bound, but this definition has no frame rate to convert a duration with. Add an fps binding, or type a frame rate on the frames entry, to make this editable again.',
