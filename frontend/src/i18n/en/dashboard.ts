...
export default {
  ...
  'h3_prompt_description': 'Optimized from the final references, audio, duration, and model request; video submission stays locked until confirmation.',
  ...
  'tool_name_confirm_h3_video_prompts': 'Confirm H3 video prompts',
