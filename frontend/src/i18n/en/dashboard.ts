...
export default {
  ...
  'reference_batch_action_repair_reference_declaration': 'Next: fix the reference declaration on this unit',
  'reference_batch_action_repair_reference_assets': 'Next: add or replace the missing reference assets',
  'reference_batch_action_review_reference_selection': 'Next: review how many images this unit references',
  'reference_batch_action_enable_model_audio': 'Next: adjust the video model audio switch in settings',
  'reference_batch_action_confirm_duration': 'Next: confirm the requested length',
  ...
  'reference_batch_action_configure_video_model': 'Next: change or configure the video model in settings',
  'reference_batch_action_review_request_configuration': 'Next: review the generation setup for this unit',
