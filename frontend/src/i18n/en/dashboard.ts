...
export default {
  ...
  'reference_duration_batch_more': '{{count}} more units differ as well.',
  'reference_duration_precheck_failed': 'Could not check the length for {{count}} units; they were not queued. Try again.',
