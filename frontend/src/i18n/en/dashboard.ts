...
export default {
  ...
  'openclaw_skill_url_label': 'Installation guide URL:',
  ...
  'openclaw_step_02_title': 'OpenClaw installs and connects',
  'openclaw_step_02_desc': 'OpenClaw follows the guide to install [[brand]] skills, connect to the remote MCP server, and verify the connection.',
  ...
  'openclaw_system_prompt': 'Read {{guideUrl}}, then follow its installation and connection steps to add [[brand]] to this environment',
