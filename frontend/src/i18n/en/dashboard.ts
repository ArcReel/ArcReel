...
export default {
  ...
  'reference_duration_confirm_title': "Generated length won't match the request basis",
  ...
  'reference_duration_note_longer': 'The model accepts only fixed length options. The clip is delivered at the requested length and is not trimmed back to the request basis.',
  ...
  'reference_duration_batch_summary': "{{count}} units will use a generation tier that doesn't match the request basis:",
