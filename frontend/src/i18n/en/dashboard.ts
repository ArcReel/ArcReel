...
export default {
  ...
  'video_style_visual_treatment': 'Moving-image treatment',
  'video_style_visual_treatment_placeholder': 'For example: realistic craft documentary with natural materials and warm daylight',
  'video_style_camera_language': 'Camera language',
  'video_style_camera_language_placeholder': 'For example: macro close-ups, slow stable moves, no aggressive shake',
  'video_style_pacing': 'Pacing',
  'video_style_pacing_placeholder': 'For example: longer takes, sparse cuts, complete physical actions',
  'video_style_sound_focus': 'Sound focus',
  'video_style_sound_focus_balanced': 'Balanced',
  'video_style_sound_focus_asmr': 'ASMR',
  'video_style_sound_focus_dialogue': 'Dialogue',
  'video_style_sound_focus_ambience': 'Ambience',
  'video_style_sound_focus_silent': 'Silent',
  'video_style_music_policy': 'Background music',
  'video_style_music_policy_auto': 'Decide automatically',
  'video_style_music_policy_none': 'No background music',
  'video_style_music_policy_custom': 'Custom music direction',
  'video_style_music_description': 'Music direction',
  'video_style_music_description_placeholder': 'Describe instrumentation, tempo, and emotional development',
  'video_style_sound_design': 'Sound design',
  'video_style_sound_design_placeholder': 'For example: foreground wire scraping, tweezers, enamel pouring, and stone grinding',
  'video_style_additional_instructions': 'Other project-wide requirements',
  'video_style_additional_instructions_placeholder': 'Only include requirements that apply to every video unit',
