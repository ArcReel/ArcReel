...
export default {
  ...
  'character_voice_binding_prompt_label': 'By voice description',
  'character_voice_binding_reference_audio_label': 'By reference audio',
  'character_voice_binding_prompt_desc': 'Writes each character\'s voice description into the prompt so the video model voices them from that description. Simple to set up and uses no reference-asset quota, but the same character only sounds roughly similar across clips.',
  'character_voice_binding_reference_audio_desc': 'Uploads or generates reference audio per character and submits it with each request, so the video model reuses that exact voice. Best cross-clip consistency, but every speaking character needs reference audio and it counts against the model\'s reference-audio limit.',
  'character_voice_binding_optional_hint': 'This project voices characters from their descriptions, so reference audio is not in use. To enable it, switch character voice binding to "By reference audio" in project settings.',
  ...
  'prompt_preview_saved_only': 'Rendered from the saved script — word for word what this shot sends to the model.',
  'prompt_preview_saved_only_dirty': 'You have unsaved changes; this preview still reflects the saved script.',
  ...
  'loading_preprocessing': 'Loading script plan results...',
  'no_preprocessing_content': 'No script plan results',
  ...
  'reference_tab_preprocess': 'Script Plan',
  ...
  'external_agent_setup_command': '2. Start setup',
  'external_agent_setup_command_desc': 'Return to the external agent, enter this command, then provide the endpoint and API Key when asked.',
  'external_agent_copy_setup_command': 'Copy setup command',
  'external_agent_setup_copied': 'Setup command copied.',
  ...
  'ce_import_relation_newer': 'Existing is newer',
  'ce_import_relation_same': 'Same version',
  'ce_import_relation_older': 'Existing is older',
  'ce_import_schema_mismatch': 'The file uses format version {{file}}; this version of the app reads {{current}}.',
