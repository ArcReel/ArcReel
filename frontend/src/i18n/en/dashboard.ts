...
export default {
  ...
  'preprocessing': 'Content Organization',
  ...
  'preprocessing_tab': 'Content Organization',
  ...
  'loading_preprocessing': 'Loading content organization results...',
  'no_preprocessing_content': 'No content organization results',
  ...
  'reference_tab_preprocess': 'Content Organization',
  ...
  'review_fix_request_prefill_header':
    'Episode {{episode}}’s content organization draft has {{count}} violation(s) to fix — call open_draft with doc_type={{docType}} to read it, then correct it with patch_draft using the same doc_type and pass the returned revision as base_revision:',
  ...
  'reference_step1_confirm_blocked_hint': 'Blocking violations are present — confirm once the agent finishes fixing them',
  ...
  'reference_step1_fix_request_prefill_header':
    'Episode {{episode}}’s reference-to-video content organization draft has {{count}} violation(s) to fix — call open_draft with doc_type=reference_step1 to read it, then correct it with patch_draft using the same doc_type and pass the returned revision as base_revision:',
  ...
  'tab_preprocessing': 'Content Organization',
  'tab_timeline': 'Shots',
  ...
  'grid_preview_empty_episode': 'No shots in this episode — organize the content first',
  ...
  'tool_name_get_step1_content': 'Read step 1 content',
  ...
  'external_agent_mcp_endpoint_desc': "Use this URL in your external agent's MCP configuration.",
  'external_agent_copy_mcp_endpoint': 'Copy MCP endpoint',
  'external_agent_mcp_endpoint_copied': 'MCP endpoint copied.',
  'external_agent_api_key_desc': 'Create an arc- API Key, then copy and save it immediately.',
  'external_agent_manage_api_keys': 'Generate or copy API Key',
  'external_agent_install_command': 'Install ArcReel skills',
  'external_agent_install_command_desc': 'Run both commands in a terminal to install setup and production workflow knowledge.',
  'external_agent_copy_install_command': 'Copy install commands',
  'external_agent_install_command_copied': 'Install commands copied.',
  'external_agent_copy_failed': 'Copy failed. Select and copy the content above manually.',
  'external_agent_install_guide': 'Installation guide',
  'external_agent_install_guide_desc': 'Follow the guide to configure your client, add the API Key, and verify the connection.',
  'external_agent_view_install_guide': 'View the full installation guide',
