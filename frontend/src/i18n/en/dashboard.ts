...
export default {
  ...
  'reference_batch_confirm_intro_one': '{{count}} unit will be generated at the length below; confirming queues them together:',
  'reference_batch_confirm_intro_other': '{{count}} units will be generated at the lengths below; confirming queues them together:',
  'reference_batch_tier_units_one': '{{count}} unit',
  'reference_batch_tier_units_other': '{{count}} units',
  'reference_batch_tier_cost': '{{cost}} total',
  'reference_batch_tier_cost_unknown': 'Total cost unavailable',
  'reference_batch_tier_unknown': 'length TBD',
  'reference_batch_unit_tiers': 'Current {{current}} → requested {{request}}',
  ...
  'reference_batch_blocked_intro': 'No tasks were created. Fix the units below, then run the batch again.',
  'reference_batch_withheld_title_one': '{{count}} more unit has no issue of its own and was held back with this batch:',
  'reference_batch_withheld_title_other': '{{count}} more units have no issue of their own and were held back with this batch:',
  'reference_batch_skipped_one': '{{count}} unit already has a video and was skipped',
  'reference_batch_skipped_other': '{{count}} units already have videos and were skipped',
  'reference_batch_request_failed': 'Batch generation request failed: {{error}}',
  // Keys mirror the closed GenerationAction set — the admission payload's action is already
  // normalized onto it server-side, so upstream modules' own action words never appear here.
  'reference_batch_action_retry': 'Next: try again shortly',
  'reference_batch_action_resume': 'Next: resume this unit',
  'reference_batch_action_fix_input': 'Next: review and fix the generation setup for this unit',
  'reference_batch_action_generate_dependency': 'Next: add or replace the missing reference assets',
  'reference_batch_action_generate_tts': 'Next: generate the narration audio for this unit',
  'reference_batch_action_regenerate_tts': 'Next: regenerate the narration audio for this unit',
  'reference_batch_action_wait_for_task': 'Next: wait for the running task to finish, then retry',
  'reference_batch_action_replan_unit': 'Next: replan this unit',
  'reference_batch_action_confirm_request_duration': 'Next: confirm the requested length',
  'reference_batch_action_configure_provider': 'Next: change or configure the video model in settings',
  'reference_batch_action_repair_artifact_state': "Next: repair this unit's artifact state",
