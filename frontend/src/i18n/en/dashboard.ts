...
export default {
  ...
  'external_agent_install_command_desc': 'Run this command in a terminal to install setup and production workflow knowledge.',
  'external_agent_copy_install_command': 'Copy install command',
  'external_agent_install_command_copied': 'Install command copied.',
