...
export default {
  ...
  'ce_comfyui_readonly': 'This is a ComfyUI endpoint: its definition is a workflow plus node bindings, not a declarative form. Only its identity is shown here; the node-binding editor arrives in a later version.',
