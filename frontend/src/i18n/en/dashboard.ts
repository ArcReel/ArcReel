...
export default {
  ...
  'import_recent_workflows': 'Import Recent Workflows',
  'importing_workflows': 'Importing workflows...',
  ...
  'model_display_name_label': 'Display name',
  'model_display_name_placeholder': 'Enter a recognizable model name',
  'workflow_name_label': 'Workflow name',
  'workflow_name_placeholder': 'Example: MiniMax H3 · Multimodal reference video',
  ...
  'comfyui_discovery_empty_hint': 'Run the target video workflow successfully in ComfyUI, then click "Import Recent Workflows".',
  'comfyui_api_key_optional': 'Optional; only needed when a reverse proxy in front of ComfyUI uses bearer-token authentication.',
  'comfyui_discovery_help': 'Imports reusable video workflows from recent successful ComfyUI jobs',
  ...
  'discovery_format_comfyui': 'ComfyUI Workflow',
  ...
  'endpoint_comfyui_workflow_display': 'ComfyUI Video Workflow',
