...
export default {
  ...
  'openai_model_sync_status': 'Discovered {{count}} available text models from OpenAI and merged them with the built-in catalog.',
  ...
  'asset_prompt_scene_label': 'Scene library prompt',
  'asset_prompt_prop_label': 'Prop library prompt',
  'asset_prompt_restore_default': 'Restore built-in default',
  'asset_prompt_merge_hint': 'The description entered for an asset is preserved and sent to the image model together with this system prompt.',
  'media_config_saved': 'Media model configuration saved',
  'asset_prompts_saved': 'Asset prompt configuration saved',
