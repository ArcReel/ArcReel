export default {
  ...
  'step_step1_content': 'Draft breakdown',
  'step_step1_review': 'Draft review',
  'step_final_script': 'Final script',
  'step_asset_sheets': 'Asset sheets',
  ...
  'task_type_grid': 'Storyboard grid',
  ...
  'result_title': '{{requested}} requested · {{succeeded}} succeeded · {{failed}} failed · {{blocked}} blocked',
  'result_skipped_one': '{{count}} unit already had a result and was skipped.',
  'result_skipped_other': '{{count}} units already had results and were skipped.',
  'item_state_succeeded': 'Succeeded',
  'item_state_failed': 'Failed',
  'item_state_blocked': 'Blocked',
  'item_task_state': 'Attempt: {{state}}',
  'item_artifact_status': 'File: {{status}}',
  ...
  // ---- Next-step phrases ----
  'action_unknown': 'follow the guidance from the assistant',
  'action_none': 'nothing to do',
  'action_retry': 'try again shortly',
  'action_resume': 'resume this unit',
  ...
  'action_repair_project_data': 'ask the assistant to repair the damaged project file',
  ...
  'action_prepare_step1': 'prepare the draft breakdown for this episode',
  'action_confirm_step1': 'review and confirm the draft breakdown',
  'action_generate_script': 'generate the final script',
  'action_generate_asset_sheets': 'generate the missing asset sheets',
  'action_generate_storyboards': 'generate the missing storyboards',
  'action_generate_grid': 'generate the storyboard grid',
