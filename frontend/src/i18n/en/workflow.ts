export default {
  ...
  'step_step1_content': 'Content organization',
  'step_step1_review': 'Content confirmation',
  ...
  'step_video_unit_storyboard_sheet': 'Video Unit Storyboard Sheet',
  'step_reference_keyframes': 'Reference keyframes',
  'step_narration_delivery': 'Narration delivery',
  'step_video_prompt_optimization': 'H3 prompt optimization',
  'step_video': 'Video',
  'step_export': 'Export',
  ...
  'task_type_reference_storyboard_sheet': 'Video Unit Storyboard Sheet',
  'task_type_reference_keyframe': 'Reference keyframe',
  ...
  'action_generate_reference_storyboard_sheets': 'generate missing Video Unit Storyboard Sheets',
  'action_confirm_reference_storyboard_sheet': 'review and confirm the current Video Unit Storyboard Sheet',
  'action_generate_reference_keyframes': 'generate missing reference keyframes',
  ...
  'problem_h3_prompt_missing': 'The optimized H3 prompt has not been generated.',
  'problem_h3_prompt_stale': 'The H3 prompt no longer matches the current request facts and must be refreshed.',
  'problem_h3_prompt_pending_review': 'The H3 prompt is waiting for review and confirmation.',
  'problem_reference_keyframe_images_required': 'Some planned keyframe first-frame images are still missing.',
