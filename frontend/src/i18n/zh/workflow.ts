...
export default {
  ...
  'step_step1_content': '内容切分',
  'step_step1_review': '切分审阅',
  'step_final_script': '正式剧本',
  'step_asset_sheets': '资产参考图',
  'step_script_structure': '剧本结构',
  'step_storyboard': '分镜图',
  ...
  'artifact_stale_of_usable_one': '其中 {{count}} 件比剧本旧',
  'artifact_stale_of_usable_other': '其中 {{count}} 件比剧本旧',
  ...
  'action_repair_project_data': '请助手修复损坏的项目文件',
  ...
  'action_prepare_step1': '为这一集准备内容切分',
  'action_confirm_step1': '审阅并确认内容切分',
  'action_generate_script': '生成正式剧本',
  'action_generate_asset_sheets': '生成缺失的资产参考图',
  'action_generate_storyboards': '生成缺失的分镜图',
  'action_generate_grid': '生成宫格分镜',
  'action_repair_video_units': '修正下面列出的剧本单元',
