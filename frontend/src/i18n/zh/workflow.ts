...
export default {
  ...
  'step_step1_content': '内容整理',
  'step_step1_review': '内容确认',
  ...
  'step_reference_keyframes': '关键分镜首帧',
  'step_narration_delivery': '旁白交付',
  'step_video_prompt_optimization': 'H3 提示词优化',
  'step_video': '视频',
  'step_export': '导出',
  ...
  'task_type_reference_keyframe': '关键分镜首帧',
  ...
  'action_generate_reference_storyboard_sheets': '生成缺失的 Video Unit Storyboard Sheet',
  'action_confirm_reference_storyboard_sheet': '审阅并确认当前 Video Unit Storyboard Sheet',
  'action_generate_reference_keyframes': '生成缺失的关键分镜首帧',
  ...
  'problem_h3_prompt_missing': '尚未生成 H3 优化提示词。',
  'problem_h3_prompt_stale': 'H3 提示词与当前请求事实不一致，需要重新优化。',
  'problem_h3_prompt_pending_review': 'H3 提示词正在等待审核确认。',
  'problem_reference_keyframe_images_required': '仍有已规划的关键分镜首帧尚未生成。',
