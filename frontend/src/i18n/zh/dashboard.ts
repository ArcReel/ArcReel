...
export default {
  ...
  'character_voice_binding_prompt_label': '按声音描述',
  'character_voice_binding_reference_audio_label': '按参考音频',
  'character_voice_binding_prompt_desc': '把角色的声音特征写进提示词，让视频模型照描述配音。设置简单、不额外占用参考素材配额，但同一角色在不同片段之间的音色只能大致接近。',
  'character_voice_binding_reference_audio_desc': '为角色上传或生成参考音频，生成时随请求一并提交，让视频模型直接复用该音色，跨片段一致性最好。需要先给每个有台词的角色准备参考音频，且会占用模型的参考音频段数上限。',
  'character_voice_binding_optional_hint': '当前项目按声音描述配音，参考音频暂不生效。要启用，请在项目设置里把角色声音绑定方式改为「按参考音频」。',
  ...
  'prompt_preview_saved_only': '按已保存的剧本渲染，与这一分镜实际送进模型的文本逐字一致。',
  'prompt_preview_saved_only_dirty': '有未保存的修改；预览仍按已保存的剧本渲染。',
  ...
  'loading_preprocessing': '正在加载脚本规划结果...',
  'no_preprocessing_content': '暂无脚本规划结果',
