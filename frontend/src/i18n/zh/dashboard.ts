...
export default {
  ...
  'reference_batch_confirm_intro_one': '{{count}} 个单元将按下列档位生成，确认后一并入队：',
  'reference_batch_confirm_intro_other': '{{count}} 个单元将按下列档位生成，确认后一并入队：',
  'reference_batch_tier_units_one': '{{count}} 个单元',
  'reference_batch_tier_units_other': '{{count}} 个单元',
  'reference_batch_tier_cost': '合计 {{cost}}',
  'reference_batch_tier_cost_unknown': '合计费用暂不可得',
  'reference_batch_tier_unknown': '档位待定',
  'reference_batch_unit_tiers': '当前 {{current}} → 申请 {{request}}',
  'reference_batch_confirm_cta': '按这些档位生成',
  'reference_batch_blocked_title': '批量生成未开始',
  'reference_batch_blocked_intro': '没有创建任何任务。处理下列单元后再试一次。',
  'reference_batch_blocked_cta': '知道了',
  'reference_batch_withheld_title_one': '另有 {{count}} 个单元本身没有问题，随本批一起未提交：',
  'reference_batch_withheld_title_other': '另有 {{count}} 个单元本身没有问题，随本批一起未提交：',
  'reference_batch_skipped_one': '{{count}} 个单元已有成片，本次跳过',
  'reference_batch_skipped_other': '{{count}} 个单元已有成片，本次跳过',
  'reference_batch_request_failed': '批量生成请求失败：{{error}}',
  // 键名对应 GenerationAction 的封闭取值——准入载荷里的 action 已由服务端归一到该集合，
  // 上游各模块自己的动作词不会出现在这里。
  'reference_batch_action_retry': '下一步：稍后重试',
  'reference_batch_action_resume': '下一步：续传该单元',
  'reference_batch_action_fix_input': '下一步：检查并修正该单元的生成配置',
  'reference_batch_action_generate_dependency': '下一步：补齐或替换缺失的引用资产',
  'reference_batch_action_generate_tts': '下一步：为该单元生成旁白配音',
  'reference_batch_action_regenerate_tts': '下一步：重新生成该单元的旁白配音',
  'reference_batch_action_wait_for_task': '下一步：等待在途任务结束后重试',
  'reference_batch_action_replan_unit': '下一步：重新规划该单元',
  'reference_batch_action_confirm_request_duration': '下一步：确认申请的时长档位',
  'reference_batch_action_configure_provider': '下一步：在设置里更换或配置视频模型',
  'reference_batch_action_repair_artifact_state': '下一步：修复该单元的产物状态',
