...
export default {
  ...
  'openai_model_sync_status': '已从 OpenAI 发现 {{count}} 个可用文本模型，并与内置目录合并',
  ...
  'asset_prompt_scene_label': '场景库提示词',
  'asset_prompt_prop_label': '道具库提示词',
  'asset_prompt_restore_default': '恢复内置默认',
  'asset_prompt_merge_hint': '用户在资产中填写的描述不会被覆盖，会与此系统提示词共同发送给图片模型。',
  'media_config_saved': '媒体模型配置已保存',
  'asset_prompts_saved': '素材提示词配置已保存',
  'usage_stats': '用量统计',
