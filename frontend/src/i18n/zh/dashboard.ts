...
export default {
  ...
  'external_agent_setup_command': '2. 启动接线',
  'external_agent_setup_command_desc': '回到外部智能体，输入以下命令并按提示提供端点和 API Key。',
  'external_agent_copy_setup_command': '复制 setup 命令',
  'external_agent_setup_copied': 'setup 命令已复制。',
  ...
  'ce_import_relation_newer': '已有的更新',
  'ce_import_relation_same': '版本相同',
  'ce_import_relation_older': '已有的更旧',
  'ce_import_schema_mismatch': '文件使用的格式版本为 {{file}}，当前版本读取 {{current}}。',
