...
export default {
  ...
  'loading_preprocessing': '正在加载内容整理结果...',
  'no_preprocessing_content': '暂无内容整理结果',
  ...
  'review_fix_request_prefill_header':
    '第 {{episode}} 集的内容整理草稿有 {{count}} 处违约待修复，请用 doc_type={{docType}} 调用 open_draft 读取草稿，再用同一 doc_type 调用 patch_draft 修正，并把 open_draft 返回的 revision 作为 base_revision 传入：',
  ...
  'reference_step1_confirm_blocked_hint': '存在阻断违约，Agent 修复完成后才能确认',
  ...
  'reference_step1_fix_request_prefill_header':
    '第 {{episode}} 集参考生视频的内容整理草稿有 {{count}} 处违约待修复，请用 doc_type=reference_step1 调用 open_draft 读取草稿，再用同一 doc_type 调用 patch_draft 修正，并把 open_draft 返回的 revision 作为 base_revision 传入：',
  ...
  'tab_preprocessing': '内容整理',
  'tab_timeline': '分镜',
  'timeline_script_not_ready': '脚本尚未生成，先在「内容整理」中完成内容确认',
  ...
  'grid_preview_empty_episode': '该集尚无分镜，先在「内容整理」中拆分脚本',
  ...
  'tool_name_get_step1_content': '读取第一阶段内容',
  ...
  'tool_name_generate_step1': '生成内容结构',
  ...
  'external_agent_mcp_endpoint_desc': '在外部智能体的 MCP 配置中使用此地址。',
  'external_agent_copy_mcp_endpoint': '复制 MCP 端点',
  'external_agent_mcp_endpoint_copied': 'MCP 端点已复制。',
  'external_agent_api_key_desc': '创建 arc- API Key，并在创建后立即复制保存。',
  'external_agent_manage_api_keys': '生成或复制 API Key',
  'external_agent_install_command': '安装 ArcReel skills',
  'external_agent_install_command_desc': '在终端执行这两条命令，分别安装接线与创作工作流知识。',
  'external_agent_copy_install_command': '复制两条安装命令',
  'external_agent_install_command_copied': '两条安装命令已复制。',
  'external_agent_copy_failed': '复制失败，请手动选择并复制上方内容。',
  'external_agent_install_guide': '安装指引',
  'external_agent_install_guide_desc': '按手册完成客户端配置、API Key 填写与连通验证。',
  'external_agent_view_install_guide': '查看完整安装指引',
