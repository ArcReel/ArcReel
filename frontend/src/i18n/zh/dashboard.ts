...
export default {
  ...
  'asset_checklist_title': '资产清单',
  'asset_checklist_hint': '点击下方入口登记角色、场景、道具等资产，帮助生成时画面保持一致。',
  'generate_prompt_dialog_title': '确认生成',
  'generate_prompt_dialog_prompt_label': '提示词（可编辑）',
  'generate_prompt_dialog_aspect_ratio_label': '画布比例',
  'generate_prompt_dialog_aspect_ratio_default': '默认（16:9）',
  'generate_prompt_dialog_image_size_label': '画质',
  'generate_prompt_dialog_image_size_default': '项目默认',
  'generate_prompt_dialog_loading': '加载提示词中…',
  'generate_prompt_dialog_load_failed': '提示词加载失败：{{message}}',
  'generate_prompt_dialog_retry': '重试',
  'generate_prompt_dialog_confirm': '确认生成',
