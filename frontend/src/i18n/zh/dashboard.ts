...
export default {
  ...
  'reference_batch_action_repair_reference_declaration': '下一步：修正该单元的引用声明',
  'reference_batch_action_repair_reference_assets': '下一步：补齐或替换缺失的引用资产',
  'reference_batch_action_review_reference_selection': '下一步：检查该单元引用的图片数量',
  'reference_batch_action_enable_model_audio': '下一步：在设置里调整视频模型的音轨开关',
  'reference_batch_action_confirm_duration': '下一步：确认申请的时长档位',
  'reference_batch_action_confirm_request_duration': '下一步：确认申请的时长档位',
  'reference_batch_action_replan_unit': '下一步：重新规划该单元',
  'reference_batch_action_configure_video_model': '下一步：在设置里更换或配置视频模型',
  'reference_batch_action_review_request_configuration': '下一步：检查该单元的生成配置',
