...
export default {
  ...
  'import_recent_workflows': '导入近期成功工作流',
  'importing_workflows': '正在导入工作流…',
  ...
  'model_display_name_label': '显示名称',
  'model_display_name_placeholder': '输入便于识别的模型名称',
  'workflow_name_label': '工作流名称',
  'workflow_name_placeholder': '例如：MiniMax H3 · 全模态多图视频',
  ...
  'comfyui_discovery_empty_hint': '先在 ComfyUI 中成功运行一次目标视频工作流，然后点击「导入近期成功工作流」。',
  'comfyui_api_key_optional': '可选；仅当 ComfyUI 前面的反向代理使用 Bearer Token 鉴权时填写。',
  'comfyui_discovery_help': '从 ComfyUI 最近成功的任务中导入可复用视频工作流',
  ...
  'discovery_format_comfyui': 'ComfyUI 工作流',
  'endpoint_label': '调用端点',
  ...
  'endpoint_comfyui_workflow_display': 'ComfyUI 视频工作流',
