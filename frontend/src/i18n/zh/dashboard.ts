...
export default {
  ...
  'chat_role_user': '你',
  'chat_role_assistant': '智能体',
  'chat_role_system': '系统',
  'chat_role_message': '消息',
  'agent_sdk_desc': '基于 Claude Agent SDK，驱动对话式 AI 智能体与自动化工作流',
  ...
  'agent_failure_startup_title': '智能体启动失败',
  'agent_failure_turn_title': '智能体本轮运行失败',
  ...
  'agent_failure_open_settings': '打开智能体设置',
  ...
  'product_task_submitted_toast': '商品「{{name}}」设计图生成任务已提交',
  ...
  'episodes_title': '剧集',
  'no_episodes_ai_hint': '暂无剧集。使用 AI 智能体生成脚本。',
  ...
  'reference_step1_quarantined_unit_hint': '本视频单元的修复由智能体在草稿上完成，晋升后此处更新。',
  ...
  'reference_step1_request_fix': '让智能体修复',
  ...
  'episode_workspace_no_episode': '这一集还没开始制作。从脚本开始，或让智能体帮你起草。',
  ...
  'open_assistant_panel': '展开智能体面板',
  'resize_assistant_panel': '调整智能体面板宽度（双击恢复默认）',
  ...
  'ad_init_generate_sheet_label': '生成商品设计图',
  'ad_init_generate_sheet_hint': '把随手拍整理成标准多角度设计图，生成后可在商品页审核与重新生成',
  ...
  'lobby_card_stale_assets_one': '{{count}} 张设计图比当前内容旧',
  'lobby_card_stale_assets_other': '{{count}} 张设计图比当前内容旧',
