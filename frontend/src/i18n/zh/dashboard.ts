...
export default {
  ...
  'ai_providers': 'AI 供应商',
  'ai_providers_desc': '管理助手的 AI 供应商。拖拽或使用箭头设置优先级顺序。系统会在供应商失败时自动回退到下一个。',
  'add_provider': '添加供应商',
  'no_providers': '暂无供应商。点击"添加供应商"开始。',
  'active': '使用中',
  'set_active': '设为活跃',
  'edit': '编辑',
  'delete': '删除',
  'cannot_delete_active': '不能删除正在使用的供应商',
  'test_connection': '测试连接',
  'test_ok': '连接成功',
  'test_warn': '可连接，但 discovery 端点失败',
  'test_fail': '无法连接',
  'fallback_hint': '💡 提示：拖拽设置优先级顺序。顶部的供应商会优先尝试。',
  'priority_saved': '优先级顺序已保存',
  'assistant_provider': '助手供应商',
  'assistant_provider_desc': '选择助手使用的 AI 供应商。Claude Agent SDK 提供沙箱代码执行；LiteLLM 支持 100+ LLM 供应商。',
  'openai_compatible': 'OpenAI 兼容',
  'openai_compatible_desc': '直接连接 OpenAI 兼容服务器 (vllm, ollama, text-generation-webui 等)',
  'credentials_section_desc': '管理媒体供应商 (视频、图片、文本) 的 API 密钥。',
  'select_model': '选择模型...',
  ...
  'generation_concurrency': '生成并发数',
  'generation_concurrency_desc': '同时生成的图片/视频数量。数值越低 = 越稳定，数值越高 = 越快。更改立即生效。',
  'image_max_workers': '图片并发数',
  'image_max_workers_hint': '同时生成的最大图片数（1-10）。机器较弱时设为 1。',
  'video_max_workers': '视频并发数',
  'video_max_workers_hint': '同时生成的最大视频数（1-10）。机器较弱时设为 1。',
  'usage_stats': '用量统计',
  ...
  'comfyui_settings': 'ComfyUI 设置',
  'comfyui_sampler': '采样器',
  'comfyui_steps': '步数',
  'comfyui_cfg': 'CFG Scale',
  'comfyui_negative_prompt': '负面提示词',
  'comfyui_clip_skip': 'Clip Skip',
  'comfyui_settings_hint': '留空使用默认值。更改将在生成图片时生效。',
  'comfyui_negative_prompt_placeholder': 'bad quality, blurry, ...',
  'comfyui_overrides': 'ComfyUI 覆盖设置',
  'comfyui_overrides_desc': '为此项目覆盖全局 ComfyUI 设置。留空使用全局默认值。',
  'comfyui_project_override_hint': '这些设置仅覆盖此项目的全局模型设置。',
  ...
  'endpoint_comfyui_image_display': 'ComfyUI 图片',
  'endpoint_comfyui_video_display': 'ComfyUI 视频',
  'endpoint_comfyui_audio_display': 'ComfyUI 音频',
  'endpoint_fal_image_display': 'fal.ai 图片',
  'endpoint_fal_video_display': 'fal.ai 视频',
  'endpoint_fal_audio_display': 'fal.ai 音频 (TTS/音乐)',
