...
export default {
  ...
  'project_style_title': '项目风格',
  'style_desc_hint': '参考图会参与后续画面生成；风格描述用于补充视觉规则，校准整体调性、材质和镜头气质。',
  'style_tag_unset': '未设置风格标签',
  'uploading_style_image': '上传中...',
  'upload_style_reference': '上传风格参考图',
  'supported_formats': '支持 PNG / JPG / WEBP',
  'usage_guide': '使用说明',
  'style_usage_with_image': '当前参考图会作为统一视觉基线，用于角色图、分镜图和视频生成。',
  'style_usage_without_image': '还没有绑定项目级参考图，可以先上传一张目标风格样片作为统一基线。',
  'replace_reference': '替换参考图',
  'deleting_reference': '删除中...',
  'delete_reference': '删除参考图',
  'upload_style_ref_aria': '上传风格参考图',
  'style_desc_char_count': '{{count}} 字',
  'style_desc_auto_hint': '上传参考图后系统会自动分析并填充风格描述；你也可以继续手动校准。',
  'style_desc_textarea_placeholder': '上传风格参考图后，系统会自动分析并填充风格描述；也可以手动编辑。',
  'style_tip_with_image': '建议把风格描述用于补充光线、色彩、材质与镜头语言。',
  'style_tip_without_image': '没有参考图时，也可以先用文字明确画面风格和审美约束。',
  'save_style_description': '保存风格描述',
  'style_desc_saved': '风格描述已保存',
  'loading_project_data': '加载项目数据中...',
  'narration_visuals_mode': '说书+画面模式',
  'drama_animation_mode': '剧集动画模式',
