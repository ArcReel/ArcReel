...
export default {
  ...
  'style_save': '保存风格',
  'style_saved_to_library': '风格已保存，并加入自定义风格列表',
  'style_saving': '保存中…',
  'style_clear': '取消风格',
  'style_cleared_hint': '保存后将移除当前风格',
  'style_description_label': '风格描述',
  'style_description_hint': '可以直接输入风格提示词，也可以先解析上方参考图，再继续修改。',
  'style_description_placeholder': '输入用于后续生成的风格提示词',
  'style_input_or': '或者直接输入',
  'style_analyze': '解析风格',
  'style_analyzing': '解析中…',
  'style_analysis_complete': '风格解析完成',
  'style_analysis_failed': '风格解析失败：{{message}}',
  'importing': '导入中...',
  'import_zip': '导入 ZIP',
  ...
  // TTS 生成参考音频样本
  'voice_sample_action': '生成角色参考音频',
  'voice_sample_not_configured_hint': '请先在设置中配置视频或音频供应商',
  'voice_sample_video_unavailable_tts_hint': '视频生成不可用，可使用 TTS 生成参考音频',
  'voice_sample_modal_title': '生成语音参考样本',
  'voice_sample_modal_desc': '为「{{name}}」生成约 10 秒的声音候选，试听满意后确认保存为角色参考音频。',
  'voice_sample_mode_video': '视频提取（默认）',
  'voice_sample_mode_tts': 'TTS 音色',
  'voice_sample_video_mode_hint': '后台会生成一段单人、干净背景的独白视频并只保留音频；独白视频不会展示或保存。',
  ...
  'voice_sample_text_default': '大家好，我是{{name}}。这是我自然说话的声音。请记住我说话的方式，很高兴在接下来的故事里认识你。',
  'voice_sample_text_hint': '目标时长约 10 秒；视频模型不支持 10 秒时会自动采用最接近且不超过 10 秒的档位。',
  ...
  'image_model_project_default': '使用项目默认模型',
  ...
  'global_video_resolution_title': '视频模型默认分辨率',
  'global_video_resolution_desc': '按模型设置全局默认值；项目内设置会优先覆盖。留空则使用系统安全默认或供应商默认值。',
  'global_video_resolution_aria': '{{model}} 的默认分辨率',
  'auto_select': '自动选择',
  ...
  'auto_edit_hyperframes': '自动剪辑',
  'auto_edit_hyperframes_hint': '生成项目内剪辑工程，并打开完整 HyperFrames Studio',
  'hyperframes_workspace_ready': 'HyperFrames 剪辑工程已就绪',
  'hyperframes_auto_edit_started': 'HyperFrames 自动剪辑已交给 Agent，Studio 将实时显示进度',
  'hyperframes_prepare_failed': 'HyperFrames 剪辑工程创建失败：{{message}}',
  'hyperframes_instruction': '剪辑 Instruction（可选）',
  'hyperframes_instruction_hint': 'Agent 会先根据正式剧本生成剪辑方案，再用这里的要求覆盖默认节奏、风格或取舍。',
  'hyperframes_instruction_placeholder': '例如：保持视频单元顺序，前三秒更有冲击力；字幕使用简洁白字；转场不要太花。',
  'hyperframes_background_music': '自动配置背景音乐',
  'hyperframes_background_music_hint': '需要时使用自有 GPU 生成一条贯穿全片的纯器乐音乐，音量固定为 15%。',
  'hyperframes_preparing': '正在准备工程…',
  'hyperframes_start_auto_edit': '开始自动剪辑',
  'select_episode': '选择集数',
  ...
  'character_catalog_token_configured': '已配置：{{masked}}',
  'character_catalog_token_missing': '尚未配置令牌',
  ...
  'video_style_section_title': '统一视频风格',
  'video_style_section_description': '项目只有一份视听导演设定，供全部视频单元和 H3 提示词优化共同使用。',
  'video_style_source_agent': 'Agent 推断',
  'video_style_source_user': '用户设置',
  'video_style_source_agent_hint': '根据项目概述、视觉风格和已拆分剧本生成，可直接编辑。',
  'video_style_source_user_hint': '当前配置由用户编辑，后续生成不会自动覆盖。',
  'video_style_analyze': 'Agent 分析并创建',
  'video_style_analyzing': '正在分析…',
  'video_style_analysis_complete': '已生成项目统一视频风格',
  'video_style_existing_reused': '已有统一视频风格，已直接读取',
  'video_style_analysis_failed': '视频风格分析失败：{{message}}',
  'video_style_save': '保存视频风格',
  'video_style_saved': '统一视频风格已保存',
  'video_style_save_failed': '视频风格保存失败：{{message}}',
  'video_style_missing_hint': '未配置时，H3 生成前会自动分析一次。',
  ...
  'route_reference_video_desc': '按 Video Unit 生成并确认 Video Unit Storyboard Sheet，再生成关键帧，并与资产图一起作为视频参考',
  'grid_storyboard_label': '多宫格分镜生视频',
  'grid_storyboard_desc': '多个场景合成一张大图一次生成，画风和角色更一致，创建后可随时切换',
  ...
  'reference_video_style_summary': '视频风格：{{summary}}',
  'reference_video_style_missing': '未配置，生成前自动分析',
  'reference_video_style_edit_aria': '查看或编辑项目统一视频风格',
  ...
  'reference_editor_view_keyframes': '关键分镜',
  'reference_editor_view_storyboard': 'Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_title': 'Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirmed_badge': '已确认',
  'reference_storyboard_sheet_pending_badge': '待确认',
  'reference_storyboard_sheet_generating': '正在生成 Video Unit Storyboard Sheet…',
  'reference_storyboard_sheet_not_generated': 'Video Unit Storyboard Sheet 尚未生成',
  'reference_storyboard_sheet_help': '这是当前整个 Video Unit 的镜头顺序与场景变化预览。必须确认当前 Sheet 后，系统才会批量生成关键首帧。',
  'reference_storyboard_sheet_generate': '生成 Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_regenerate': '重新生成 Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirm_and_generate': '确认 Video Unit Storyboard Sheet 并生成关键帧',
  'reference_keyframe_storyboard_gate': '请先生成并确认当前 Video Unit 的 Storyboard Sheet，确认后才可进入关键分镜生成。',
  ...
  'reference_keyframe_delete': '删除关键分镜',
  'reference_keyframe_delete_confirm': '确定删除这个关键分镜及其文稿引用吗？',
  'reference_keyframe_empty': '当前视频单元尚未定义关键分镜。',
  'reference_keyframe_add': '增加关键场景',
  'reference_keyframe_add_placeholder': '描述该段视频 00:00.000 的静态切入画面，不要写动作结果',
  ...
  'reference_picker_group_keyframe': '关键分镜',
  ...
  'reference_picker_tab_keyframe': '关键分镜',
  ...
  'reference_tab_h3_prompts': 'H3 提示词',
  'reference_tab_hyperframes': 'HyperFrames',
  'hyperframes_studio_title': 'HyperFrames Studio 编辑器',
  'hyperframes_studio_starting': '正在启动 HyperFrames Studio…',
  'hyperframes_studio_start_failed': 'HyperFrames Studio 启动失败',
  'hyperframes_retry': '重试',
  'hyperframes_open_new_window': '在新窗口打开',
  'h3_prompt_title': 'MiniMax H3 视频提示词',
  'h3_prompt_description': '基于最终参考图、音频、时长和模型参数自动优化。',
  'h3_prompt_units': '视频单元',
  'h3_prompt_refresh': '刷新提示词状态',
  'h3_prompt_optimize': '优化提示词',
  'h3_prompt_confirm': '确认并放行',
  'h3_prompt_empty': '尚未生成优化提示词。',
  'h3_prompt_auto_pending': '生成视频时将自动优化 H3 提示词。',
  'h3_prompt_auto_running': '视频生成链路正在自动优化 H3 提示词…',
  'h3_prompt_ready_description': '当前视频单元将使用以下 H3 提示词。',
  'h3_prompt_edit_label': '编辑 MiniMax H3 视频提示词',
  'h3_prompt_state_not_applicable': '不适用',
  'h3_prompt_state_missing': '未生成',
  'h3_prompt_state_stale': '已过期',
  'h3_prompt_state_pending_review': '待审核',
  'h3_prompt_state_confirmed': '已确认',
  ...
  'h3_progress_aria': 'MiniMax H3 视频生成进度',
  'h3_progress_style': '风格分析',
  'h3_progress_optimize': '提示词优化',
  'h3_progress_submitted': '已提交',
  'h3_progress_queued': '排队中',
  'h3_progress_generating': '生成视频',
  'h3_progress_style_detail': '正在分析项目统一视频风格…',
  'h3_progress_optimize_detail': '正在做提示词优化…',
  'h3_progress_submitted_detail': '任务已提交',
  'h3_progress_queued_waiting': '正在排队，等待获取位置…',
  'h3_progress_queued_detail': '正在排队，前面 {{ahead}} 个（队列共 {{total}} 个）',
  'h3_progress_preparing_detail': '正在准备生成资源…',
  'h3_progress_running_detail': '正在生成视频 {{progress}}%',
  'h3_progress_cancelling_detail': '正在取消远端生成任务…',
  'h3_progress_cancel': '取消 H3 生成',
  ...
  'insufficient_scenes_for_grid': '场景不足，无法生成多宫格分镜',
  ...
  'reference_step1_unit_text_label': '{{unit}} 正文',
  ...
  'reference_step1_confirm_continue_prefill': '第 {{episode}} 集的拆分已确认，请继续生成脚本与参考视频。',
  'reference_step1_fix_request_prefill_header':
    '第 {{episode}} 集参考视频的内容整理草稿有 {{count}} 处违约待修复，请直接编辑待修复草稿修正：',
  'reference_step1_fix_request_promote_prefill':
    '第 {{episode}} 集参考视频的内容整理草稿重新校验已无违约，仍是待修复草稿，请调用 validate_and_promote_draft 晋升为正式内容。',
  ...
  'tab_timeline': '分镜',
  'timeline_script_not_ready': '脚本尚未生成，先在「预处理」中完成审阅',
  ...
  'grid_preview_empty_episode': '该集尚无分镜，先在「预处理」中拆分脚本',
  ...
  'tool_name_get_episode_script_revision': '读取脚本版本',
  ...
  'tool_name_confirm_asset_sheets': '确认现有素材为最新',
  ...
  'tool_name_generate_reference_storyboard_sheets': '生成 Video Unit Storyboard Sheet',
  'tool_name_confirm_reference_storyboard_sheet': '确认 Video Unit Storyboard Sheet 并生成关键帧',
  'tool_name_generate_reference_keyframes': '生成参考视频关键帧',
  ...
  'tool_name_optimize_h3_video_prompts': '优化 H3 视频提示词',
  'tool_name_update_h3_video_prompt': '更新 H3 视频提示词',
  'tool_name_prepare_hyperframes_episode': '准备 HyperFrames 剪辑工程',
  'tool_name_generate_hyperframes_bgm': '生成 HyperFrames 背景音乐',
  ...
  'tool_name_analyze_video_style': '分析统一视频风格',
  'tool_name_update_video_style': '编辑统一视频风格',
  ...
  'skill_name_hyperframes_auto_edit': 'HyperFrames 自动剪辑',
  ...
  'lobby_hero_greeting_morning': '早上好，小伙伴。',
  'lobby_hero_greeting_noon': '中午好，小伙伴。',
  'lobby_hero_greeting_afternoon': '下午好，小伙伴。',
  'lobby_hero_greeting_evening': '晚上好，小伙伴。',
  'lobby_hero_greeting_late': '夜深了，小伙伴。',
  ...
  'openclaw_step_03_desc': '描述你的创作需求，OpenClaw 将调用 [[brand]] 完成项目管理、脚本生成和视频创作',
