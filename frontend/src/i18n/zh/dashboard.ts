...
export default {
  ...
  'video_style_visual_treatment': '动态画面处理',
  'video_style_visual_treatment_placeholder': '例如：写实传统工艺纪录片，保留自然材质与暖色日光',
  'video_style_camera_language': '镜头语言',
  'video_style_camera_language_placeholder': '例如：微距特写、缓慢稳定运镜、避免剧烈摇晃',
  'video_style_pacing': '节奏',
  'video_style_pacing_placeholder': '例如：长镜头、低切换密度、完整展示动作过程',
  'video_style_sound_focus': '声音重点',
  'video_style_sound_focus_balanced': '平衡',
  'video_style_sound_focus_asmr': 'ASMR',
  'video_style_sound_focus_dialogue': '对白',
  'video_style_sound_focus_ambience': '环境声',
  'video_style_sound_focus_silent': '静音',
  'video_style_music_policy': '背景音乐',
  'video_style_music_policy_auto': '自动决定',
  'video_style_music_policy_none': '禁止背景音乐',
  'video_style_music_policy_custom': '指定音乐方向',
  'video_style_music_description': '音乐方向',
  'video_style_music_description_placeholder': '描述乐器、速度和情绪变化',
  'video_style_sound_design': '声音设计',
  'video_style_sound_design_placeholder': '例如：突出铜丝刮擦、镊子碰撞、釉料倾倒和石磨研磨声',
  'video_style_additional_instructions': '其他项目级要求',
  'video_style_additional_instructions_placeholder': '只填写需要作用于全部视频单元的要求',
  'video_model': '视频模型',
