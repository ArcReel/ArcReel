export default {
  ...
  text_tier_default_caption: "其他档位留空时回退到此模型。",
  text_tier_simple_label: "简单任务",
  text_tier_simple_caption: "覆盖项目概述、风格图分析；此档模型需支持图像输入。",
  text_tier_complex_label: "复杂任务",
  text_tier_complex_caption: "覆盖剧本生成、分集规划、内容抽取与拆分。",
  text_tier_agent_boundary: "智能体对话与 subagent 推理由智能体供应商配置决定。",
  reasoning_effort_label: "推理强度",
  reasoning_effort_provider_default: "使用模型默认值（GPT-5.6 默认 medium）",
  reasoning_effort_hint: "强度越高通常思考更深入，但延迟与 Token 消耗也可能增加。",
  reasoning_effort_available: "推理强度：{{levels}}",
  reasoning_effort_none: "无",
  reasoning_effort_low: "低",
  reasoning_effort_medium: "中",
  reasoning_effort_high: "高",
  reasoning_effort_xhigh: "超高",
  reasoning_effort_max: "最大",
  duration_label: "默认时长",
  duration_auto: "auto",
