...
export default {
  ...
  bucket_i2i_caption: "图片编辑任务也使用图生图模型。",
  bucket_i2v_label: "图生视频",
  bucket_i2v_caption: "覆盖由分镜图或多宫格分镜图驱动的视频生成，也适用于参考生视频路径中没有参考图的视频单元。",
  bucket_r2v_label: "参考生视频",
  bucket_r2v_caption: "覆盖参考生视频路径中带参考图的视频单元。",
  ...
  text_tier_agent_boundary: "Agent 对话与子智能体推理由 Agent 供应商配置决定。",
  duration_label: "默认时长",
  duration_auto: "auto",
  ...
  duration_unsupported_reference_notice: "已保存的时长 {{value}} 秒在参考生视频下不可用，请重新选择。",
